...
enum class ExtraSignalAction { GENERATE_COREDUMP = 1 };
...
void dl_assert__(const char *expr, const char *file_name, const char *func_name, int line, const char *desc, int use_perror, int generate_coredump);
