...
static uint32_t aarch64_native_crc(const void *buffer, long int len, uint32_t crc) {
...
static uint32_t aarch64_native_crc_pmull(const void *buf, long int size, unsigned crc) {
  int64_t length = size;
