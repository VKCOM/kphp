...
class index_of_type : public std::integral_constant<std::size_t, 1 + index_of_type<T1, Args...>::value> {};

template<class T, class... Args>
class index_of_type<T, T, Args...> : public std::integral_constant<std::size_t, 0> {};
