...
inline void f$set_detect_incorrect_encoding_names_warning(bool show) noexcept { StringLibContext::get().detect_incorrect_encoding_names = show; }

inline void free_detect_incorrect_encoding_names() noexcept { StringLibContext::get().detect_incorrect_encoding_names = false; }
