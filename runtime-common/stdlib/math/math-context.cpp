...
MathLibConstants::MathLibConstants() noexcept
    : ONE(ONE_.data(), static_cast<string::size_type>(ONE_.size())), ZERO(ZERO_.data(), static_cast<string::size_type>(ZERO_.size())),
      TEN(TEN_.data(), static_cast<string::size_type>(TEN_.size())),
      ZERO_DOT_FIVE(ZERO_DOT_FIVE_.data(), static_cast<string::size_type>(ZERO_DOT_FIVE_.size())), BC_NUM_ONE(bcmath_impl_::bc_parse_number(ONE).first),
      BC_NUM_ZERO(bcmath_impl_::bc_parse_number(ZERO).first), BC_ZERO_DOT_FIVE(bcmath_impl_::bc_parse_number(ZERO_DOT_FIVE).first) {
