...
inline int64_t f$abs(int64_t v) noexcept { return std::abs(v); }

inline double f$abs(double v) noexcept { return std::abs(v); }

inline int64_t f$abs(const Optional<int64_t>& v) noexcept { return f$abs(val(v)); }

inline int64_t f$abs(const Optional<bool>& v) noexcept { return f$abs(static_cast<int64_t>(val(v))); }

inline double f$abs(const Optional<double>& v) noexcept { return f$abs(val(v)); }

inline double f$ceil(double v) noexcept { return ceil(v); }

inline double f$cos(double v) noexcept { return cos(v); }

inline double f$deg2rad(double v) noexcept { return v * M_PI / 180; }

inline double f$floor(double v) noexcept { return floor(v); }
...
inline double f$pi() noexcept { return M_PI; }
