...
public:
  ...
  static const char* get_json_obj_magic_key() noexcept { return "__json_obj_magic"; }
...
inline string f$JsonEncoder$$getLastError() noexcept { return SerializationLibContext::get().last_json_processor_error; }
