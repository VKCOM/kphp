...
#define CHECK_AND_ACCESS(obj, idx, check_method, get_method) ({mixed res_tmp___{}; mixed idx_tmp___ = idx; if (check_method(obj, idx_tmp___)) {res_tmp___ = get_method(obj, idx_tmp___);} res_tmp___;})
#define EMPTY_AND_ACCESS(obj, idx, check_method, get_method) ({mixed res_tmp___{}; mixed idx_tmp___ = idx; if (check_method(obj, idx_tmp___)) {mixed for_get_tmp___ = get_method(obj, idx_tmp___); if (!for_get_tmp___.empty()) { res_tmp___ = for_get_tmp___; } } res_tmp___; })
