...
#define SAFE_SET_MIXED_BY_INDEX(mix, idx, val, val_type)                                                                                                       \
  ({                                                                                                                                                           \
    val_type val_tmp___ = val;                                                                                                                                 \
    mix.set_value_return(idx, std::move(val_tmp___));                                                                                                          \
  })
#define MIXED_GET_IF_ISSET(mix, idx)                                                                                                                           \
  ({                                                                                                                                                           \
    mixed res_tmp___{};                                                                                                                                        \
    mixed mix_tmp___ = mix;                                                                                                                                    \
    auto idx_tmp___ = idx;                                                                                                                                     \
    if (mix_tmp___.isset(idx_tmp___)) {                                                                                                                        \
      res_tmp___ = mix_tmp___.get_value(idx_tmp___);                                                                                                           \
    }                                                                                                                                                          \
    res_tmp___;                                                                                                                                                \
  })
#define MIXED_GET_IF_NOT_EMPTY(mix, idx)                                                                                                                       \
  ({                                                                                                                                                           \
    mixed res_tmp___{};                                                                                                                                        \
    mixed mix_tmp___ = mix;                                                                                                                                    \
    auto idx_tmp___ = idx;                                                                                                                                     \
    if (mix_tmp___.isset(idx_tmp___)) {                                                                                                                        \
      mixed for_get_tmp___ = mix_tmp___.get_value(idx_tmp___);                                                                                                 \
      if (!for_get_tmp___.empty()) {                                                                                                                           \
        res_tmp___ = for_get_tmp___;                                                                                                                           \
      }                                                                                                                                                        \
    }                                                                                                                                                          \
    res_tmp___;                                                                                                                                                \
  })

#define ARR_ACC_SET_RETURN(obj, idx, val, method)                                                                                                              \
  ({                                                                                                                                                           \
    mixed val_tmp___ = val;                                                                                                                                    \
    method(obj, idx, val_tmp___);                                                                                                                              \
    val_tmp___;                                                                                                                                                \
  }) // it's always safe
#define ARR_ACC_GET_IF_ISSET(obj, idx, check_method, get_method)                                                                                               \
  ({                                                                                                                                                           \
    mixed res_tmp___{};                                                                                                                                        \
    auto obj_tmp___ = obj;                                                                                                                                     \
    mixed idx_tmp___ = idx;                                                                                                                                    \
    if (check_method(obj_tmp___, idx_tmp___)) {                                                                                                                \
      res_tmp___ = get_method(obj_tmp___, idx_tmp___);                                                                                                         \
    }                                                                                                                                                          \
    res_tmp___;                                                                                                                                                \
  })
#define ARR_ACC_GET_IF_NOT_EMPTY(obj, idx, check_method, get_method)                                                                                           \
  ({                                                                                                                                                           \
    mixed res_tmp___{};                                                                                                                                        \
    auto obj_tmp___ = obj;                                                                                                                                     \
    mixed idx_tmp___ = idx;                                                                                                                                    \
    if (check_method(obj_tmp___, idx_tmp___)) {                                                                                                                \
      mixed for_get_tmp___ = get_method(obj_tmp___, idx_tmp___);                                                                                               \
      if (!for_get_tmp___.empty()) {                                                                                                                           \
        res_tmp___ = for_get_tmp___;                                                                                                                           \
      }                                                                                                                                                        \
    }                                                                                                                                                          \
...
#define NOERR(a, a_type)                                                                                                                                       \
  ({                                                                                                                                                           \
    RuntimeContext::get().php_disable_warnings++;                                                                                                              \
    a_type a_tmp___ = a;                                                                                                                                       \
    RuntimeContext::get().php_disable_warnings--;                                                                                                              \
    a_tmp___;                                                                                                                                                  \
  })
...
inline constexpr int64_t operator"" _i64(unsigned long long int v) noexcept { return static_cast<int64_t>(v); }
...
inline double float_power(double base, int64_t exp) { return std::pow(base, exp); }
...
inline int64_t& power_self(int64_t& base, int64_t exp) { return base = int_power(base, exp); }

inline double& power_self(double& base, int64_t exp) { return base = float_power(base, exp); }

inline mixed& power_self(mixed& base, const mixed& exp) { return base = var_power(base, exp); }
...
double divide(int64_t lhs, int64_t rhs) { return divide(static_cast<double>(lhs), static_cast<double>(rhs)); }

double divide(double lhs, int64_t rhs) { return divide(lhs, static_cast<double>(rhs)); }

double divide(const string& lhs, int64_t rhs) { return divide(f$floatval(lhs), rhs); }

double divide(const mixed& lhs, int64_t rhs) { return divide(f$floatval(lhs), rhs); }

double divide(int64_t lhs, double rhs) { return divide(static_cast<double>(lhs), rhs); }
...
double divide(const string& lhs, double rhs) { return divide(f$floatval(lhs), rhs); }

double divide(const mixed& lhs, double rhs) { return divide(f$floatval(lhs), rhs); }

double divide(int64_t lhs, const string& rhs) { return divide(lhs, f$floatval(rhs)); }

double divide(double lhs, const string& rhs) { return divide(lhs, f$floatval(rhs)); }

double divide(const string& lhs, const string& rhs) { return divide(f$floatval(lhs), f$floatval(rhs)); }

double divide(const mixed& lhs, const string& rhs) { return divide(lhs, f$floatval(rhs)); }

double divide(int64_t lhs, const mixed& rhs) { return divide(lhs, f$floatval(rhs)); }

double divide(double lhs, const mixed& rhs) { return divide(lhs, f$floatval(rhs)); }

double divide(const string& lhs, const mixed& rhs) { return divide(f$floatval(lhs), rhs); }

double divide(const mixed& lhs, const mixed& rhs) { return divide(f$floatval(lhs), f$floatval(rhs)); }
...
int64_t& modulo_self(int64_t& lhs, int64_t rhs) { return lhs = modulo(lhs, rhs); }
...
bool& boolval_ref(bool& val) { return val; }

bool& boolval_ref(mixed& val) { return val.as_bool("unknown"); }

const bool& boolval_ref(const bool& val) { return val; }

const bool& boolval_ref(const mixed& val) { return val.as_bool("unknown"); }

int64_t& intval_ref(int64_t& val, const char*) { return val; }

int64_t& intval_ref(mixed& val, const char* function) { return val.as_int(function); }

const int64_t& intval_ref(const int64_t& val, const char*) { return val; }

const int64_t& intval_ref(const mixed& val, const char* function) { return val.as_int(function); }

double& floatval_ref(double& val) { return val; }

double& floatval_ref(mixed& val) { return val.as_float("unknown"); }

const double& floatval_ref(const double& val) { return val; }

const double& floatval_ref(const mixed& val) { return val.as_float("unknown"); }

string& strval_ref(string& val, const char*) { return val; }

string& strval_ref(mixed& val, const char* function) { return val.as_string(function); }

const string& strval_ref(const string& val, const char*) { return val; }

const string& strval_ref(const mixed& val, const char* function) { return val.as_string(function); }
...
array<mixed>& arrayval_ref(mixed& val, const char* function) { return val.as_array(function); }
...
const array<mixed>& arrayval_ref(const mixed& val, const char* function) { return val.as_array(function); }
...
bool f$empty(const mixed& v) { return v.empty(); }
...
bool f$is_numeric(const string& v) { return v.is_numeric(); }

bool f$is_numeric(const mixed& v) { return v.is_numeric(); }
...
bool f$is_null(const mixed& v) { return v.is_null(); }
...
bool f$is_int(const mixed& v) { return v.is_int(); }
...
bool f$is_float(const mixed& v) { return v.is_float(); }
...
bool f$is_scalar(const mixed& v) { return v.is_scalar(); }
...
bool f$is_string(const mixed& v) { return v.is_string(); }
...
bool f$is_array(const mixed& v) { return v.is_array(); }
...
const char* get_type_c_str(bool) { return "boolean"; }

const char* get_type_c_str(int64_t) { return "integer"; }

const char* get_type_c_str(double) { return "double"; }

const char* get_type_c_str(const string&) { return "string"; }

const char* get_type_c_str(const mixed& v) { return v.get_type_c_str(); }
...
inline string& append(string& dest, tmp_string from) { return dest.append(from.data, from.size); }

string& append(string& dest, const string& from) { return dest.append(from); }

inline string& append(string& dest, int64_t from) { return dest.append(from); }
...
inline mixed& append(mixed& dest, tmp_string from) { return dest.append(from); }
...
string f$gettype(const mixed& v) { return v.get_type_str(); }
...
mixed f$error_get_last() { return {}; }

void f$warning(const string& message) { php_warning("%s", message.c_str()); }
...
int64_t f$get_reference_counter(const string& v) { return v.get_reference_counter(); }

int64_t f$get_reference_counter(const mixed& v) { return v.get_reference_counter(); }
...
array<mixed>::iterator begin(mixed& x) { return x.begin(); }

array<mixed>::const_iterator begin(const mixed& x) { return x.begin(); }

array<mixed>::const_iterator const_begin(const mixed& x) { return x.begin(); }
...
array<mixed>::iterator end(mixed& x) { return x.end(); }

array<mixed>::const_iterator end(const mixed& x) { return x.end(); }

array<mixed>::const_iterator const_end(const mixed& x) { return x.end(); }
...
void clear_array(mixed& v) { v.clear(); }
