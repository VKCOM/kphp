...
public:
  ...
  void* allocate0(size_t size) noexcept { return memset(allocate(size), 0x00, size); }

  void* reallocate(void* mem, size_t new_size, size_t old_size) noexcept { return details::universal_reallocate(*this, mem, new_size, old_size); }
