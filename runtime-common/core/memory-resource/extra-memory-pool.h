...
public:
  ...
  uint8_t* memory_begin() { return reinterpret_cast<uint8_t*>(this + 1); }
  ...
  static size_t get_pool_payload_size(size_t buffer_size) noexcept { return buffer_size - sizeof(extra_memory_pool); }

  size_t get_pool_payload_size() const noexcept { return get_pool_payload_size(buffer_size_); }

  size_t get_buffer_size() const noexcept { return buffer_size_; }
...
public:
  ...
  size_t buffers_count() const noexcept { return buffers_count_; }
