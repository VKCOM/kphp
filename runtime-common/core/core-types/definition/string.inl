...
bool string::string_inner::is_shared() const { return ref_count > 0; }
...
char* string::string_inner::ref_data() const { return (char*)(this + 1); }
...
inline string::size_type string::string_inner::get_memory_usage() const { return static_cast<size_type>(sizeof(string_inner) + (capacity + 1)); }
...
string::string_inner* string::inner() const { return (string::string_inner*)p - 1; }

bool string::disjunct(const char* s) const { return (s < p || p + size() < s); }
...
string::string(const string& str) noexcept : p(str.inner()->ref_copy()) {}
...
string::string(const char* s) : string(s, static_cast<size_type>(strlen(s))) {}
...
string::string(ArrayBucketDummyStrTag) noexcept : p(nullptr) {}

bool string::is_dummy_string() const noexcept { return p == nullptr; }

string& string::operator=(const string& str) noexcept { return assign(str); }
...
string::size_type string::size() const { return inner()->size; }
...
string::size_type string::capacity() const { return inner()->capacity; }
...
bool string::starts_with(const string& other) const noexcept { return other.size() > size() ? false : !memcmp(c_str(), other.c_str(), other.size()); }
...
const char& string::operator[](size_type pos) const { return p[pos]; }

char& string::operator[](size_type pos) { return p[pos]; }
...
string& string::append(const char* s) { return append(s, static_cast<size_type>(strlen(s))); }
...
string& string::append(double d) { return append(string(d)); }
...
string& string::assign(const char* s) { return assign(s, static_cast<size_type>(strlen(s))); }
...
char* string::buffer() { return p; }

const char* string::c_str() const { return p; }
...
inline bool string::try_to_int(int64_t* val) const { return php_try_to_int(p, size(), val); }
...
int64_t string::to_int() const { return to_int(p, size()); }

int64_t string::to_int(int64_t start, int64_t l) const { return to_int(p + start, l); }
...
const string& string::to_string() const { return *this; }
...
bool string::is_int() const { return php_is_int(p, size()); }
...
int64_t string::hash() const { return string_hash(p, size()); }

string string::substr(size_type pos, size_type n) const { return string(p + pos, n); }
...
int64_t string::compare(const string& str) const { return compare(*this, str.c_str(), str.size()); }

bool string::isset(int64_t index) const { return index >= 0 && index < size(); }

int64_t string::get_correct_index(int64_t index) const { return index >= 0 ? index : index + int64_t{size()}; }
...
int64_t string::get_correct_offset(int64_t offset) const { return get_correct_offset(size(), offset); }
...
int64_t string::get_reference_counter() const { return inner()->ref_count + 1; }

bool string::is_reference_counter(ExtraRefCnt ref_cnt_value) const noexcept { return inner()->ref_count == ref_cnt_value; }
...
inline string::size_type string::estimate_memory_usage() const { return inner()->get_memory_usage(); }
...
bool operator==(const string& lhs, const string& rhs) { return lhs.size() == rhs.size() && lhs.compare(rhs) == 0; }

bool operator!=(const string& lhs, const string& rhs) { return lhs.size() != rhs.size() || lhs.compare(rhs) != 0; }

bool is_ok_float(double v) { return v == 0.0 || (std::fpclassify(v) == FP_NORMAL && v < 1e100 && v > -1e100); }
...
string::size_type max_string_size(bool) { return static_cast<string::size_type>(STRLEN_BOOL); }

string::size_type max_string_size(int32_t) { return static_cast<string::size_type>(STRLEN_INT); }

string::size_type max_string_size(int64_t) { return static_cast<string::size_type>(STRLEN_INT); }

string::size_type max_string_size(double) { return static_cast<string::size_type>(STRLEN_FLOAT); }

string::size_type max_string_size(const string& s) { return s.size(); }

string::size_type max_string_size(tmp_string s) { return s.size; }
...
struct stl_string_less {
  bool operator()(const string& lhs, const string& rhs) const noexcept { return lhs.compare(rhs) < 0; }
};
