...
inline mixed::type mixed::get_type() const { return type_; }

inline bool mixed::is_null() const { return get_type() == type::NUL; }

inline bool mixed::is_bool() const { return get_type() == type::BOOLEAN; }

inline bool mixed::is_int() const { return get_type() == type::INTEGER; }

inline bool mixed::is_float() const { return get_type() == type::FLOAT; }

inline bool mixed::is_string() const { return get_type() == type::STRING; }

inline bool mixed::is_array() const { return get_type() == type::ARRAY; }

inline bool mixed::is_object() const { return get_type() == type::OBJECT; }
...
inline void swap(mixed& lhs, mixed& rhs) { lhs.swap(rhs); }
