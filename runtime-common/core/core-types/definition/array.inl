...
array_size::array_size(int64_t int_size, bool is_vector) noexcept : size(int_size), is_vector(is_vector) {}

array_size array_size::operator+(const array_size& other) const noexcept { return {size + other.size, is_vector && other.is_vector}; }
...
template <class T>
array<T>::array() : p(array_inner::empty_array()) {}

template <class T>
array<T>::array(const array_size& s) : p(array_inner::create(s.size, s.is_vector)) {}

template <class T>
template <class KeyT>
inline array<T>::array(const std::initializer_list<std::pair<KeyT, T>>& list) : array() {
...
template <class T>
array<T>::array(const array<T>& other) noexcept : p(other.p->ref_copy()) {}

template <class T>
array<T>::array(array<T>&& other) noexcept : p(other.p) {
