...
private:
  struct string_8bytes {
    ...
    constexpr explicit string_8bytes(char c) : inner{1, 1, ExtraRefCnt::for_global_const}, data{c, '\0'} {}

    template <size_t... Digits>
    constexpr explicit string_8bytes(std::index_sequence<Digits...>)
        : inner{sizeof...(Digits), sizeof...(Digits), ExtraRefCnt::for_global_const}, data{static_cast<char>('0' + Digits)..., '\0'} {}
  ...
  public:
    constexpr single_char_storage_hack() noexcept : single_char_storage_hack{std::make_index_sequence<std::tuple_size<single_char_storage>{}>{}} {}
  };
  ...
  static constexpr auto constexpr_make_small_ints() noexcept { return constexpr_make_ints(std::make_index_sequence<small_int_max() / 10>{}); }
