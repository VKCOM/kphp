...
inline bool f$boolval(tmp_string val) { return val.to_bool(); }

inline bool f$boolval(const string& val) { return val.to_bool(); }
...
inline bool f$boolval(const mixed& val) { return val.to_bool(); }
...
inline int64_t f$intval(const string& val) { return val.to_int(); }

inline int64_t f$intval(const mixed& val) { return val.to_int(); }
...
inline int64_t f$safe_intval(bool val) { return val; }

inline int64_t f$safe_intval(int64_t val) { return val; }
...
inline int64_t f$safe_intval(const string& val) { return val.safe_to_int(); }

inline int64_t f$safe_intval(const mixed& val) { return val.safe_to_int(); }
...
inline double f$floatval(const string& val) { return val.to_float(); }

inline double f$floatval(const mixed& val) { return val.to_float(); }
...
inline string f$strval(bool val) { return (val ? string("1", 1) : string()); }

inline string f$strval(int64_t val) { return string(val); }

inline string f$strval(double val) { return string(val); }

inline string f$strval(const string& val) { return val; }

inline string&& f$strval(string&& val) { return std::move(val); }
...
inline string f$strval(const mixed& val) { return val.to_string(); }

inline string f$strval(mixed&& val) { return val.is_string() ? std::move(val.as_string()) : val.to_string(); }
...
inline array<mixed> f$arrayval(const mixed& val) { return val.to_array(); }

inline array<mixed> f$arrayval(mixed&& val) { return val.is_array() ? std::move(val.as_array()) : val.to_array(); }
