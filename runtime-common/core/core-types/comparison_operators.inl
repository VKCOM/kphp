...
inline bool eq2(bool lhs, bool rhs) { return lhs == rhs; }
inline bool eq2(int64_t lhs, int64_t rhs) { return lhs == rhs; }
inline bool eq2(double lhs, double rhs) { return lhs == rhs; }
inline bool eq2(const string& lhs, const string& rhs) { return compare_strings_php_order(lhs, rhs) == 0; }
...
inline bool eq2(bool lhs, int64_t rhs) { return lhs != !rhs; }
inline bool eq2(int64_t lhs, bool rhs) { return eq2(rhs, lhs); }

inline bool eq2(bool lhs, double rhs) { return lhs != (rhs == 0.0); }
inline bool eq2(double lhs, bool rhs) { return eq2(rhs, lhs); }

inline bool eq2(int64_t lhs, double rhs) { return static_cast<double>(lhs) == rhs; }
inline bool eq2(double lhs, int64_t rhs) { return eq2(rhs, lhs); }

inline bool eq2(bool lhs, const string& rhs) { return lhs == rhs.to_bool(); }
inline bool eq2(const string& lhs, bool rhs) { return eq2(rhs, lhs); }
...
inline bool eq2(const string& lhs, int64_t rhs) { return eq2(rhs, lhs); }
...
inline bool eq2(const string& lhs, double rhs) { return eq2(rhs, lhs); }
...
inline bool eq2(bool lhs, const mixed& rhs) { return lhs == rhs.to_bool(); }
inline bool eq2(const mixed& lhs, bool rhs) { return eq2(rhs, lhs); }
...
inline bool eq2(const mixed& lhs, double rhs) { return eq2(rhs, lhs); }
...
inline bool eq2(const mixed& lhs, int64_t rhs) { return eq2(rhs, lhs); }

inline bool eq2(const string& lhs, const mixed& rhs) { return eq2(mixed(lhs), rhs); }
inline bool eq2(const mixed& lhs, const string& rhs) { return eq2(rhs, lhs); }
...
inline bool equals(const may_be_mixed_base* lhs, const may_be_mixed_base* rhs) { return lhs == rhs; }

inline bool equals(bool lhs, const mixed& rhs) { return rhs.is_bool() && equals(lhs, rhs.as_bool()); }
inline bool equals(const mixed& lhs, bool rhs) { return equals(rhs, lhs); }

inline bool equals(int64_t lhs, const mixed& rhs) { return rhs.is_int() && equals(lhs, rhs.as_int()); }
inline bool equals(const mixed& lhs, int64_t rhs) { return equals(rhs, lhs); }

inline bool equals(double lhs, const mixed& rhs) { return rhs.is_float() && equals(lhs, rhs.as_double()); }
inline bool equals(const mixed& lhs, double rhs) { return equals(rhs, lhs); }

inline bool equals(const string& lhs, const mixed& rhs) { return rhs.is_string() && equals(lhs, rhs.as_string()); }
inline bool equals(const mixed& lhs, const string& rhs) { return equals(rhs, lhs); }
...
inline bool lt(const bool& lhs, const bool& rhs) { return lhs < rhs; }
template <class T1, class T2>
