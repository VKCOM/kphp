...
template<class ReturnType, class FallbackType>
requires(kphp::coro::is_async_function_v<FallbackType>) task_t<ReturnType> perform_fallback_impl(
...
template<class ReturnType, class FallbackType>
requires(kphp::coro::is_async_function_v<FallbackType>) task_t<ReturnType> perform_fallback_impl(FallbackType &&value_fallback) noexcept {
...
template<class ReturnType, class FallbackType>
requires(kphp::coro::is_async_function_v<FallbackType>) task_t<ReturnType> perform_fallback(FallbackType &&value_fallback) noexcept {
...
public:
  ...
  template<class FallbackType>
  requires(kphp::coro::is_async_function_v<FallbackType>) task_t<ResultType> finalize(FallbackType &&fallback) noexcept {
