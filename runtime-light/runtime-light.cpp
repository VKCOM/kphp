...
VISIBILITY_DEFAULT void k2_init_image() {
  ...
  void const_vars_check_reference_counter();
  // Ensure that all reference-counted objects have their reference counters initialized to ExtraRefCnt::for_global_const.
  // This check is crucial to prevent race conditions on the reference counter during concurrent access.
  const_vars_check_reference_counter();
