...
void InstanceState::init_script_execution() noexcept {
  ...
  main_task_async_stack_frame.async_stack_root = coroutine_instance_state.next_root;
  coroutine_instance_state.next_root->top_async_stack_frame = std::addressof(main_task_async_stack_frame);
