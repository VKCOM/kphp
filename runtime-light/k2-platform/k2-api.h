...
inline void* mmap(uint64_t* md, void* addr, size_t len, int32_t prot, int32_t flags, uint64_t fd, uint64_t offset) noexcept {
  return k2_mmap(md, addr, len, prot, flags, fd, offset);
}
