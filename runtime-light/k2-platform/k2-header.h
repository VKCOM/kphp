...
/**
 * Even if env is available at any point, try to cache and parse it as soon as possible (during k2_create_component or even
 * k2_create_image). Environment are constant and do not change during the component lifetime.
