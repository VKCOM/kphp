...
#include "runtime-light/core/runtime_types/array_iterator.h"
...
private:
  ...
  struct array_inner : array_inner_control {
    ...
    inline const array_bucket *begin() const __attribute__ ((always_inline));
    inline const array_bucket *next(const array_bucket *ptr) const __attribute__ ((always_inline));
    inline const array_bucket *prev(const array_bucket *ptr) const __attribute__ ((always_inline));
    inline const array_bucket *end() const __attribute__ ((always_inline));

    inline array_bucket *begin() __attribute__ ((always_inline));
    inline array_bucket *next(array_bucket *ptr) __attribute__ ((always_inline));
    inline array_bucket *prev(array_bucket *ptr) __attribute__ ((always_inline));
    inline array_bucket *end() __attribute__ ((always_inline));
