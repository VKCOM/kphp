...
SimpleCoroutineScheduler& SimpleCoroutineScheduler::get() noexcept { return InstanceState::get().scheduler; }
...
ScheduleStatus SimpleCoroutineScheduler::scheduleOnYield() noexcept { return ScheduleStatus::Skipped; }
