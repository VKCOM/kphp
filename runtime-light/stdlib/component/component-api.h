...
struct C$ComponentQuery final : public refcountable_php_classes<C$ComponentQuery> {
  ...
  constexpr const char* get_class() const noexcept { return "ComponentQuery"; }

  constexpr int32_t get_hash() const noexcept { return static_cast<int32_t>(std::hash<std::string_view>{}(get_class())); }
