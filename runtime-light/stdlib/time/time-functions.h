...
inline Optional<int64_t> f$mktime(Optional<int64_t> hour = {}, Optional<int64_t> minute = {}, Optional<int64_t> second = {}, Optional<int64_t> month = {},
  ...
  auto res =
      kphp::timelib::mktime(static_cast<std::optional<int64_t>>(hour), static_cast<std::optional<int64_t>>(minute), static_cast<std::optional<int64_t>>(second), static_cast<std::optional<int64_t>>(month), static_cast<std::optional<int64_t>>(day), static_cast<std::optional<int64_t>>(year));
  if (res.has_value()) {
    return *res;
  }
  return false;
