...
inline string f$mb_strtolower(const string& str, const string& encoding = StringImageState::get().CP1251_STR) noexcept {
  return mb_strtolower_impl(str, [](bool condition) noexcept { kphp::log::assertion(condition); }, encoding);
}

inline string f$mb_strtoupper(const string& str, const string& encoding = StringImageState::get().CP1251_STR) noexcept {
...
inline Optional<int64_t> f$mb_stripos(const string& haystack, const string& needle, int64_t offset = 0,
                                      const string& encoding = StringImageState::get().CP1251_STR) noexcept {
