...
inline mixed f$str_replace(const mixed &, const mixed &, const mixed &, int64_t & = StringComponentState::get().str_replace_count_dummy) {
  php_critical_error("call to unsupported function");
}

inline string f$str_replace(const string &, const string &, const string &, int64_t & = StringComponentState::get().str_replace_count_dummy) {
  php_critical_error("call to unsupported function");
}

template<typename T1, typename T2>
string f$str_replace(const array<T1> &, const array<T2> &, const string &, int64_t & = StringComponentState::get().str_replace_count_dummy) {
  php_critical_error("call to unsupported function");
}

inline string f$str_replace(const mixed &, const mixed &, const string &, int64_t & = StringComponentState::get().str_replace_count_dummy) {
  php_critical_error("call to unsupported function");
}
...
inline string f$str_ireplace(const string &, const string &, const string &, int64_t & = StringComponentState::get().str_replace_count_dummy) {
  php_critical_error("call to unsupported function");
}

template<typename T1, typename T2>
string f$str_ireplace(const array<T1> &, const array<T2> &, const string &, int64_t & = StringComponentState::get().str_replace_count_dummy) {
  php_critical_error("call to unsupported function");
}

inline string f$str_ireplace(const mixed &, const mixed &, const string &, int64_t & = StringComponentState::get().str_replace_count_dummy) {
  php_critical_error("call to unsupported function");
}
...
inline mixed f$str_ireplace(const mixed &, const mixed &, const mixed &, int64_t & = StringComponentState::get().str_replace_count_dummy) {
  php_critical_error("call to unsupported function");
}

inline int64_t f$similar_text(const string &, const string &, double & = StringComponentState::get().default_similar_text_percent_stub) {
  php_critical_error("call to unsupported function");
}
