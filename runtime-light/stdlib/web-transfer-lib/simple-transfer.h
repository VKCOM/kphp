...
inline auto simple_transfer_perform(simple_transfer st) noexcept -> kphp::coro::task<std::expected<response, error>> {
  ...
  const auto response_handler{
      [&frame_num, &err, &ok_or_error_buffer](std::span<std::byte> _) noexcept -> kphp::component::inter_component_session::client::wait_for_response {
        switch (frame_num) {
        case 0: {
          frame_num += 1;
          ...
          if (auto r{simple_web_transfer_perform_resp.value}; std::holds_alternative<tl::WebError>(r)) {
            ...
            return kphp::component::inter_component_session::client::wait_for_response::last_one;
          }
          return kphp::component::inter_component_session::client::wait_for_response::another_one;
        }
        case 1:
          frame_num += 1;
          return kphp::component::inter_component_session::client::wait_for_response::another_one;
