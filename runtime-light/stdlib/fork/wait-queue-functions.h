...
inline void wait_queue_push(int64_t queue_id, int64_t fork_id) noexcept {
  ...
  static constexpr auto wait_queue_wrapper_task{[](kphp::coro::shared_task<kphp::forks::details::storage> fork_task, int64_t fork_id) noexcept -> kphp::coro::task<int64_t> {
