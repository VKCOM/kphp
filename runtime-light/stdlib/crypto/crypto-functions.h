...
inline Optional<string> f$openssl_encrypt(const string &data, const string &method,
                                   const string &key, int64_t options = 0, const string &iv = string{},
                                   string &tag = CryptoComponentContext::get().default_tag_dummy, const string &aad = string{}, int64_t tag_length = 16) {
