...
inline kphp::coro::task<bool> f$fclose(resource stream) noexcept {
  if (auto sync_resource{from_mixed<class_instance<kphp::fs::sync_resource>>(stream, {})}; !sync_resource.is_null()) {
    ...
    co_return co_await kphp::coro::on_stack(
        [](kphp::fs::async_resource* async_resource) noexcept { return kphp::forks::id_managed(&kphp::fs::async_resource::close, async_resource); },
        async_resource.get());
  }
...
inline kphp::coro::task<Optional<int64_t>> f$fwrite(resource stream, string data) noexcept {
  ...
  if (auto sync_resource{from_mixed<class_instance<kphp::fs::sync_resource>>(stream, {})}; !sync_resource.is_null()) {
    ...
    auto expected{co_await kphp::coro::on_stack(
        [](kphp::fs::async_resource* async_resource, std::span<const std::byte> data) noexcept {
          return kphp::forks::id_managed(&kphp::fs::async_resource::write, async_resource, data);
        },
...
inline kphp::coro::task<Optional<string>> f$fread(resource stream, int64_t length) noexcept {
  ...
  if (auto sync_resource{from_mixed<class_instance<kphp::fs::sync_resource>>(stream, {})}; !sync_resource.is_null()) {
    ...
    expected = co_await kphp::coro::on_stack(
        [](kphp::fs::async_resource* async_resource, std::span<std::byte> data) noexcept {
          return kphp::forks::id_managed(&kphp::fs::async_resource::read, async_resource, data);
        },
...
inline kphp::coro::task<bool> f$fflush(resource stream) noexcept {
  if (auto sync_resource{from_mixed<class_instance<kphp::fs::sync_resource>>(stream, {})}; !sync_resource.is_null()) {
    ...
    co_return co_await kphp::coro::on_stack(
        [](kphp::fs::async_resource* async_resource) noexcept { return kphp::forks::id_managed(&kphp::fs::async_resource::flush, async_resource); },
        async_resource.get());
  }
