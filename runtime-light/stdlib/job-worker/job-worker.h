...
struct C$KphpJobWorkerResponseError : public refcountable_polymorphic_php_classes<C$KphpJobWorkerResponse> {
  ...
  const char* get_class() const noexcept override { return "KphpJobWorkerResponseError"; }

  int32_t get_hash() const noexcept override { return static_cast<int32_t>(std::hash<std::string_view>{}(get_class())); }

  size_t virtual_builtin_sizeof() const noexcept override { return sizeof(*this); }

  C$KphpJobWorkerResponseError* virtual_builtin_clone() const noexcept override { return new C$KphpJobWorkerResponseError{*this}; }
};
...
inline string f$KphpJobWorkerResponseError$$getError(class_instance<C$KphpJobWorkerResponseError> v$this) noexcept { return v$this.get()->error; }

inline int64_t f$KphpJobWorkerResponseError$$getErrorCode(class_instance<C$KphpJobWorkerResponseError> v$this) noexcept { return v$this.get()->error_code; }
