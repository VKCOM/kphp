...
inline auto f$curl_init(string url = string{""}) noexcept -> kphp::coro::task<kphp::web::curl::easy_type> {
  auto task{kphp::web::simple::open(kphp::web::transfer_backend::CURL)};
  auto open_res{co_await kphp::coro::on_stack(kphp::forks::id_managed<decltype(task)>, std::move(task))};
  ...
  auto setopt_res{
      kphp::web::property::set(st, static_cast<kphp::web::property::id>(kphp::web::curl::CURLOPT::URL), kphp::web::property::value::as_string(url))};
...
inline auto f$curl_setopt(kphp::web::curl::easy_type easy_id, int64_t option, const mixed& value) noexcept -> bool { // NOLINT
  ...
  if (option == std::to_underlying(kphp::web::curl::CURLINFO::HEADER_OUT)) {
    auto res{kphp::web::property::set(st, static_cast<kphp::web::property::id>(kphp::web::curl::CURLOPT::VERBOSE),
  ...
  case kphp::web::curl::CURLOPT::POSTFIELDS: {
    if (!value.is_array()) [[unlikely]] {
      auto res{kphp::web::property::set(st, static_cast<kphp::web::property::id>(kphp::web::curl::CURLOPT::COPYPOSTFIELDS),
    ...
    auto res{kphp::web::property::set(st, static_cast<kphp::web::property::id>(kphp::web::curl::CURLOPT::HTTPPOST),
...
inline auto f$curl_exec(kphp::web::curl::easy_type easy_id) noexcept -> kphp::coro::task<mixed> {
  ...
  auto task{kphp::web::simple::perform(kphp::web::simple::transfer{easy_id})};
  auto res{co_await kphp::coro::on_stack(kphp::forks::id_managed<decltype(task)>, std::move(task))};
  auto& easy_ctx{curl_state.easy_ctx.get_or_init(easy_id)};
...
inline auto f$curl_close(kphp::web::curl::easy_type easy_id) noexcept -> kphp::coro::task<void> {
  ...
  auto& easy_ctx{curl_state.easy_ctx.get_or_init(easy_id)};
  auto task{kphp::web::simple::close(kphp::web::simple::transfer{easy_id})};
  auto res{co_await kphp::coro::on_stack(kphp::forks::id_managed<decltype(task)>, std::move(task))};
  if (!res.has_value()) [[unlikely]] {
    easy_ctx.set_errno(res.error().code, res.error().description);
...
inline auto f$curl_reset(kphp::web::curl::easy_type easy_id) noexcept -> kphp::coro::task<void> {
  ...
  auto& easy_ctx{curl_state.easy_ctx.get_or_init(easy_id)};
  auto task{kphp::web::simple::reset(kphp::web::simple::transfer{easy_id})};
  auto res{co_await kphp::coro::on_stack(kphp::forks::id_managed<decltype(task)>, std::move(task))};
  if (!res.has_value()) [[unlikely]] {
    easy_ctx.set_errno(res.error().code, res.error().description);
...
inline auto f$curl_getinfo(kphp::web::curl::easy_type easy_id, int64_t option = 0) noexcept -> kphp::coro::task<mixed> {
  ...
  case kphp::web::curl::CURLINFO::NONE: {
    auto task{kphp::web::property::get(kphp::web::simple::transfer{easy_id}, std::nullopt, kphp::web::property::get_policy::load)};
    auto res{co_await kphp::coro::on_stack(kphp::forks::id_managed<decltype(task)>, std::move(task))};
    if (!res.has_value()) [[unlikely]] {
      easy_ctx.set_errno(res.error().code, res.error().description);
    ...
    const auto set_value{[&result, &info](const string& key, const kphp::web::curl::CURLINFO what) {
      const auto& v{info.find(static_cast<kphp::web::property::id>(what))};
    ...
    if (!easy_ctx.has_been_executed) {
      ...
      auto task{kphp::web::property::get(kphp::web::simple::transfer{easy_id}, url_opt_id, kphp::web::property::get_policy::cached)};
      const auto url{co_await kphp::coro::on_stack(kphp::forks::id_managed<decltype(task)>, std::move(task))};
      if (url.has_value()) {
  ...
  case kphp::web::curl::CURLINFO::HEADER_OUT: {
    auto task{kphp::web::property::get(kphp::web::simple::transfer{easy_id}, option, kphp::web::property::get_policy::load)};
    auto res{co_await kphp::coro::on_stack(kphp::forks::id_managed<decltype(task)>, std::move(task))};
    if (!res.has_value()) [[unlikely]] {
      easy_ctx.set_errno(res.error().code, res.error().description);
