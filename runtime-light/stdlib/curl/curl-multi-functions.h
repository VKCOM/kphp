...
inline auto f$curl_multi_init() noexcept -> kphp::coro::task<kphp::web::curl::multi_type> {
  auto open_res{
      co_await kphp::coro::on_stack([]() noexcept { return kphp::forks::id_managed(kphp::web::composite::open, kphp::web::transfer_backend::CURL); })};
...
inline auto f$curl_multi_add_handle(kphp::web::curl::multi_type multi_id, kphp::web::curl::easy_type easy_id) noexcept -> kphp::coro::task<Optional<int64_t>> {
  ...
  auto res{co_await kphp::coro::on_stack(
      [](kphp::web::curl::multi_type multi_id, kphp::web::curl::easy_type easy_id) noexcept {
        return kphp::forks::id_managed(kphp::web::composite::add, kphp::web::composite::transfer{multi_id}, kphp::web::simple::transfer{easy_id});
      },
      multi_id, easy_id)};
...
inline auto f$curl_multi_remove_handle(kphp::web::curl::multi_type multi_id,
  ...
  auto res{co_await kphp::coro::on_stack(
      [](kphp::web::curl::multi_type multi_id, kphp::web::curl::easy_type easy_id) noexcept {
        return kphp::forks::id_managed(kphp::web::composite::remove, kphp::web::composite::transfer{multi_id}, kphp::web::simple::transfer{easy_id});
      },
      multi_id, easy_id)};
  if (!res.has_value()) [[unlikely]] {
    multi_ctx.set_errno(res.error().code);
...
inline auto f$curl_multi_exec(kphp::web::curl::multi_type multi_id, int64_t& still_running) noexcept -> kphp::coro::task<Optional<int64_t>> {
  ...
  auto res{co_await kphp::coro::on_stack(
      [](kphp::web::curl::multi_type multi_id) noexcept {
        return kphp::forks::id_managed(kphp::web::composite::perform, kphp::web::composite::transfer{multi_id});
      },
      multi_id)};
  auto& multi_ctx{curl_state.multi_ctx.get_or_init(multi_id)};
  if (!res.has_value()) [[unlikely]] {
  ...
  if (easy_ctx.return_transfer) {
    auto res{co_await kphp::coro::on_stack(
        [](kphp::web::curl::easy_type easy_id) noexcept {
          return kphp::forks::id_managed(kphp::web::simple::get_response, kphp::web::simple::transfer{easy_id});
        },
        easy_id)};
    if (!res.has_value()) [[unlikely]] {
...
inline auto f$curl_multi_close(kphp::web::curl::multi_type multi_id) noexcept -> kphp::coro::task<void> {
  ...
  auto res{co_await kphp::coro::on_stack(
      [](kphp::web::curl::multi_type multi_id) noexcept {
        return kphp::forks::id_managed(kphp::web::composite::close, kphp::web::composite::transfer{multi_id});
      },
      multi_id)};
  if (!res.has_value()) [[unlikely]] {
    multi_ctx.set_errno(res.error().code);
...
inline auto f$curl_multi_select(kphp::web::curl::multi_type multi_id, double timeout = 1.0) noexcept -> kphp::coro::task<Optional<int64_t>> {
  ...
  auto& multi_ctx{curl_state.multi_ctx.get_or_init(multi_id)};
  auto task{[](kphp::web::curl::multi_type multi_id, std::chrono::seconds timeout) noexcept {
    return kphp::web::composite::wait_updates(kphp::web::composite::transfer{multi_id}, timeout);
  }};
  auto res{co_await kphp::coro::on_stack([](auto task, kphp::web::curl::multi_type multi_id,
                                            std::chrono::seconds timeout) noexcept { return kphp::forks::id_managed(std::move(task), multi_id, timeout); },
                                         std::move(task), multi_id, std::chrono::duration_cast<std::chrono::seconds>(std::chrono::duration<double>{timeout}))};
  if (!res.has_value()) [[unlikely]] {
    multi_ctx.set_errno(res.error().code);
...
inline auto f$curl_multi_info_read(kphp::web::curl::multi_type multi_id,
  ...
  auto props{co_await kphp::coro::on_stack(
      [](kphp::web::curl::multi_type multi_id) noexcept {
        return kphp::forks::id_managed(kphp::web::property::get<kphp::web::composite::transfer>, kphp::web::composite::transfer{multi_id},
                                       CURL_MULTI_INFO_READ_OPTION, kphp::web::property::get_policy::load);
      },
      multi_id)};
