...
struct promise_self_deleting : kphp::coro::async_stack_element {
  kphp::stl::intrusive::list_node<std::coroutine_handle<>> m_coroutine_node;
...
public:
  ...
  auto get_coroutine_node() noexcept -> kphp::stl::intrusive::list_node<std::coroutine_handle<>>& {
    return m_promise.m_coroutine_node;
  }
};

inline auto promise_self_deleting::get_return_object() noexcept -> task_self_deleting {
  m_coroutine_node = kphp::stl::intrusive::make_list_node<std::coroutine_handle<>>(std::coroutine_handle<promise_self_deleting>::from_promise(*this));
