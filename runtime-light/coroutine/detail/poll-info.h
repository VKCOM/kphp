...
struct poll_info {
  ...
  using scheduled_coroutines = kphp::stl::intrusive::list<kphp::stl::intrusive::list_node<std::coroutine_handle<>>>;
  ...
  auto operator co_await() noexcept {
    struct poll_awaiter {
      ...
      auto await_suspend(std::coroutine_handle<> awaiting_coroutine) noexcept -> void {
        m_poll_info.m_awaiting_coroutine_node = kphp::stl::intrusive::make_list_node(awaiting_coroutine);
      }
