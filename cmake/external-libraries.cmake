...
if(NOT ${H3_LIB}_FOUND)
    ...
    set(UBER_H3_STATIC_LIB ${uber-h3_BINARY_DIR}/lib/libh3.a)
    message(STATUS "---------------------")
else()
    get_target_property(UBER_H3_STATIC_LIB ${H3_LIB}::h3 LOCATION)
endif()
...
if(APPLE)
    ...
    set(EPOLL_SHIM_STATIC_LIB ${epoll_BINARY_DIR}/src/libepoll-shim.a)
endif()
