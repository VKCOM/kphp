...
struct CDataPtr {
  ...
  operator CDataPtr<void>() {
    return CDataPtr<void>(c_value);
  }

  // allow `T*` ptr to `const T*` ptr conversion
  operator CDataPtr<const T>() {
    return CDataPtr<const T>(c_value);
  }
...
template<class T>
CDataPtr<T> ffi_addr(class_instance<C$FFI$CData<T>>& cdata) {
  return CDataPtr<T>::create(&cdata->c_value);
}

template<class T>
CDataPtr<T> ffi_addr(const class_instance<C$FFI$CData<T>>& cdata) {
  return CDataPtr<T>::create(&cdata->c_value);
}

template<class T>
CDataPtr<T*> ffi_addr(T*& ref) {
  return CDataPtr<T*>::create(&ref);
}
...
template<class T>
CDataPtr<T*> ffi_addr(CDataPtr<T>& ref) {
  return CDataPtr<T*>::create(&ref.c_value);
}

template<class T>
CDataPtr<T> ffi_addr(class_instance<CDataArray<T>>& cdata) {
  return CDataPtr<T>::create(cdata->data);
}

template<class T>
CDataPtr<T> ffi_addr(const class_instance<CDataArray<T>>& cdata) {
  return CDataPtr<T>::create(cdata->data);
}
...
template<class T>
T* ffi_c_value_ptr(class_instance<C$FFI$CData<T>>& cdata) {
  return {&cdata->c_value};
}

template<class T>
T* ffi_c_value_ptr(const class_instance<C$FFI$CData<T>>& cdata) {
  return &cdata->c_value;
}

template<class T>
T* ffi_c_value_ptr(const class_instance<CDataArray<T>>& cdata) {
  return cdata->data;
}

template<class T>
T* ffi_c_value_ptr(CDataArrayRef<T> ref) {
  return ref.data;
}
...
template<class T>
CDataPtr<T> ffi_clone(CDataPtr<T> ref) {
  return ref;
}
...
template<class T>
bool f$FFI$$isNull(T* ptr) {
  return ptr == nullptr;
}

template<class T>
bool f$FFI$$isNull(CDataPtr<T> ptr) {
  return ptr.c_value == nullptr;
}
...
inline bool ffi_c2php(bool v) {
  return v;
}
inline int64_t ffi_c2php(uint8_t v) {
  return v;
}
inline int64_t ffi_c2php(uint16_t v) {
  return v;
}
inline int64_t ffi_c2php(uint32_t v) {
  return v;
}
inline int64_t ffi_c2php(uint64_t v) {
  return v;
}
inline int64_t ffi_c2php(int8_t v) {
  return v;
}
inline int64_t ffi_c2php(int16_t v) {
  return v;
}
inline int64_t ffi_c2php(int32_t v) {
  return v;
}
inline int64_t ffi_c2php(int64_t v) {
  return v;
}
inline double ffi_c2php(float v) {
  return v;
}
inline double ffi_c2php(double v) {
  return v;
}
inline string ffi_c2php(char v) {
  return {1, v};
}
...
template<class T>
class_instance<C$FFI$CData<T>> ffi_c2php(T v) {
...
struct ffi_tag<bool> {};
template<>
struct ffi_tag<uint8_t> {};
template<>
struct ffi_tag<uint16_t> {};
template<>
struct ffi_tag<uint32_t> {};
template<>
struct ffi_tag<uint64_t> {};
template<>
struct ffi_tag<int8_t> {};
template<>
struct ffi_tag<int16_t> {};
template<>
struct ffi_tag<int32_t> {};
template<>
struct ffi_tag<int64_t> {};
template<>
struct ffi_tag<float> {};
template<>
struct ffi_tag<double> {};
template<>
struct ffi_tag<char> {};
template<>
struct ffi_tag<const char*> {};
template<>
struct ffi_tag<const void*> {};
template<>
struct ffi_tag<void*> {};
template<class T>
struct ffi_tag<C$FFI$CData<T>> {};

inline bool ffi_php2c(bool v, ffi_tag<bool>) {
  return v;
}
inline uint8_t ffi_php2c(int64_t v, ffi_tag<uint8_t>) {
  return v;
}
inline uint16_t ffi_php2c(int64_t v, ffi_tag<uint16_t>) {
  return v;
}
inline uint32_t ffi_php2c(int64_t v, ffi_tag<uint32_t>) {
  return v;
}
inline uint64_t ffi_php2c(int64_t v, ffi_tag<uint64_t>) {
  return v;
}
inline int8_t ffi_php2c(int64_t v, ffi_tag<int8_t>) {
  return v;
}
inline int16_t ffi_php2c(int64_t v, ffi_tag<int16_t>) {
  return v;
}
inline int32_t ffi_php2c(int64_t v, ffi_tag<int32_t>) {
  return v;
}
inline int64_t ffi_php2c(int64_t v, ffi_tag<int64_t>) {
  return v;
}
inline float ffi_php2c(double v, ffi_tag<float>) {
  return static_cast<float>(v);
}
inline double ffi_php2c(double v, ffi_tag<double>) {
  return v;
}
inline const char* ffi_php2c(const string& v, ffi_tag<const char*>) {
  return v.c_str();
}
inline const void* ffi_php2c(const string& v, ffi_tag<const void*>) {
  return v.c_str();
}
...
inline bool ffi_php2c(Optional<bool> v, ffi_tag<bool>) {
  return v.is_null() ? false : v.val();
}
inline uint8_t ffi_php2c(Optional<int64_t> v, ffi_tag<uint8_t>) {
  return v.is_null() ? 0 : v.val();
}
inline uint16_t ffi_php2c(Optional<int64_t> v, ffi_tag<uint16_t>) {
  return v.is_null() ? 0 : v.val();
}
inline uint32_t ffi_php2c(Optional<int64_t> v, ffi_tag<uint32_t>) {
  return v.is_null() ? 0 : v.val();
}
inline uint64_t ffi_php2c(Optional<int64_t> v, ffi_tag<uint64_t>) {
  return v.is_null() ? 0 : v.val();
}
inline int8_t ffi_php2c(Optional<int64_t> v, ffi_tag<int8_t>) {
  return v.is_null() ? 0 : v.val();
}
inline int16_t ffi_php2c(Optional<int64_t> v, ffi_tag<int16_t>) {
  return v.is_null() ? 0 : v.val();
}
inline int32_t ffi_php2c(Optional<int64_t> v, ffi_tag<int32_t>) {
  return v.is_null() ? 0 : v.val();
}
inline int64_t ffi_php2c(Optional<int64_t> v, ffi_tag<int64_t>) {
  return v.is_null() ? 0 : v.val();
}
inline float ffi_php2c(Optional<double> v, ffi_tag<float>) {
  return v.is_null() ? 0 : static_cast<float>(v.val());
}
inline double ffi_php2c(Optional<double> v, ffi_tag<double>) {
  return v.is_null() ? 0 : v.val();
}

template<class T>
auto ffi_php2c(class_instance<C$FFI$CData<T>> v, ffi_tag<C$FFI$CData<T>>) {
  return v->c_value;
}

inline const char* ffi_php2c(CDataPtr<char> v, ffi_tag<const char*>) {
  return ffi_c_value_ptr(v);
}
inline const char* ffi_php2c(CDataPtr<const char> v, ffi_tag<const char*>) {
  return ffi_c_value_ptr(v);
}

template<class T>
void* ffi_php2c(CDataPtr<T> v, ffi_tag<void*>) {
  return ffi_c_value_ptr(v);
}

template<class T>
const void* ffi_php2c(CDataPtr<T> v, ffi_tag<const void*>) {
  return ffi_c_value_ptr(v);
}

template<class T>
const void* ffi_php2c(CDataPtr<const T> v, ffi_tag<const void*>) {
  return ffi_c_value_ptr(v);
}

template<class T>
T* ffi_php2c(CDataPtr<T> v, ffi_tag<C$FFI$CData<T*>>) {
  return ffi_c_value_ptr(v);
}

template<class T>
const T* ffi_php2c(CDataPtr<T> v, ffi_tag<C$FFI$CData<const T*>>) {
  return ffi_c_value_ptr(v);
}

template<class T>
const T* ffi_php2c(CDataPtr<const T> v, ffi_tag<C$FFI$CData<const T*>>) {
  return ffi_c_value_ptr(v);
}
...
inline bool ffi_vararg_php2c(bool v) {
  return v;
}
inline int64_t ffi_vararg_php2c(int64_t v) {
  return v;
}
inline double ffi_vararg_php2c(double v) {
  return v;
}
inline const char* ffi_vararg_php2c(const string& s) {
  return s.c_str();
}

template<class T>
T* ffi_vararg_php2c(CDataPtr<T> v) {
  return ffi_c_value_ptr(v);
}

template<class T>
auto ffi_vararg_php2c(class_instance<C$FFI$CData<T>> v) {
  return v->c_value;
}
