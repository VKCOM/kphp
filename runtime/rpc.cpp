...
bool f$fetch_eof (const string &file __attribute__((unused)), int line __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
...
public:
  ...
  virtual bool equals (const tl_tree *other __attribute__((unused))) const {//TODO: this unused generated by script, recheck it.
    php_assert (false);
    return false;
  }
...
inline void tl_debug (const char *s __attribute__((unused)), int n __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
//  fprintf (stderr, "%s\n", s);
}
...
void *tlsub_ret_ok (void **IP __attribute__((unused)), void **Data __attribute__((unused)), var *arr __attribute__((unused)), tl_tree **vars __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
  tl_debug (__FUNCTION__, -1);
  return TLUNI_OK;
}

void *tlsub_ret (void **IP __attribute__((unused)), void **Data, var *arr __attribute__((unused)), tl_tree **vars __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
  tl_debug (__FUNCTION__, -1);
  return *(--Data);
}
...
tl_tree *read_num_const (int *var_count __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
