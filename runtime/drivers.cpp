...
static inline void mc_stats_do(bool success){
  if (mc_stats_time > 0) {
    f$kphp_mcStats(mc_stats_port, string(mc_method, strlen(mc_method)),
                  string(mc_last_key, mc_last_key_len),
...
static inline void mc_stats_init(int port){
...
void mc_set_callback (const char *result, int result_len __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
...
void mc_delete_callback (const char *result, int result_len __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
  if (!strcmp (result, "ERROR\r\n")) {
    mc_stats_do(false);
    return;
  }
...
Memcache::host Memcache::get_host (const string &key __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
...
bool Memcache::run_set (const string &key, const var &value, int flags, int expire) {
  ...
  if (mc_is_immediate_query (real_key)) {
    ...
    mc_stats_init(cur_host.host_port);
...
bool Memcache::addServer (const string &host_name, int port, bool persistent __attribute__((unused)), int weight, int timeout, int retry_interval __attribute__((unused)), bool status __attribute__((unused)), const var &failure_callback __attribute__((unused)), int timeoutms) {//TODO: this unused generated by script, recheck it.
  if (timeout <= 0) {
    timeout = 1;
  }
...
bool Memcache::rpc_connect (const string &host_name __attribute__((unused)), int port __attribute__((unused)), const var &default_actor_id __attribute__((unused)), double timeout __attribute__((unused)), double connect_timeout __attribute__((unused)), double reconnect_timeout __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
...
RpcMemcache::host RpcMemcache::get_host (const string &key __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
  php_assert (hosts.count() > 0);
...
bool RpcMemcache::addServer (const string &host_name, int port, bool persistent __attribute__((unused)), int weight, int timeout, int retry_interval, bool status __attribute__((unused)), const var &failure_callback __attribute__((unused)), int timeoutms) {//TODO: this unused generated by script, recheck it.
  if (timeout <= 0) {
    timeout = 1;
  }
  if (timeout >= MAX_TIMEOUT) {
...
MyMemcache f$new_rich_mc (const MyMemcache &mc, const string &engine_tag __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
...
var base128DecodeMixed_pointer_dummy (var str __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
  return var();
}

string parse_backtrace_pointer_dummy (array <var> raw __attribute__((unused)), bool fun_args __attribute__((unused)) = true) {//TODO: this unused generated by script, recheck it.
  return string();
}

var apiWrapError_pointer_dummy (var error_code __attribute__((unused)), var error_description __attribute__((unused)), Exception exception __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
  return var();
}

bool adminNotifyPM_pointer_dummy (string message __attribute__((unused)), var chat_name __attribute__((unused)), var options __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
  return false;
}

var addNewLogEvent_pointer_dummy (string name, array <var> description, string engine __attribute__((unused)), var from_id, var ip, var ua_hash, var remix_sid) {//TODO: this unused generated by script, recheck it.
  return logAddEvent_pointer (name, description, from_id, ip, ua_hash, remix_sid, false);
}

var logAddEvent_pointer_dummy (string event_type __attribute__((unused)), array <var> event __attribute__((unused)), var uid __attribute__((unused)), var ip_ulong __attribute__((unused)), var ua_hash __attribute__((unused)), var remix_sid __attribute__((unused)), var port __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
  return false;
}

var uaHash_pointer_dummy (string user_agent __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
  return var();
}
...
var debugLogPlain_pointer_dummy (string section __attribute__((unused)), string text __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
  return var();
}
