...
MyMemcache f$new_rich_mc (const MyMemcache &mc, const string &engine_tag) {
...
var base128DecodeMixed_pointer_dummy (var str) {
  return var();
}

string parse_backtrace_pointer_dummy (array <var> raw, bool fun_args = true) {
  return string();
}

var apiWrapError_pointer_dummy (var error_code, var error_description, Exception exception) {
  return var();
}

bool adminNotifyPM_pointer_dummy (string message, var chat_name, var options) {
  return false;
}

var addNewLogEvent_pointer_dummy (string name, array <var> description, string engine, var from_id, var ip, var ua_hash, var remix_sid) {
  return logAddEvent_pointer (name, description, from_id, ip, ua_hash, remix_sid, false);
}

var logAddEvent_pointer_dummy (string event_type, array <var> event, var uid, var ip_ulong, var ua_hash, var remix_sid, var port) {
  return false;
}

var uaHash_pointer_dummy (string user_agent) {
  return var();
}
...
var debugLogPlain_pointer_dummy (string section, string text) {
  return var();
}
