...
inline bool eq2 (Unknown lhs __attribute__((unused)), Unknown rhs __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
  php_assert ("Comparison of Unknown" && 0);
  return false;
}
...
inline bool equals (Unknown lhs __attribute__((unused)), Unknown rhs __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
  php_assert ("Comparison of Unknown" && 0);
  return true;
}
