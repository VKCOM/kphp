...
MysqlPdoEmulatedStatement::MysqlPdoEmulatedStatement(const string& statement, int connector_id) : statement(statement), connector_id(connector_id) {}
...
int64_t MysqlPdoEmulatedStatement::affected_rows() noexcept { return response->affected_rows; }
