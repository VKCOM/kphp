...
struct BinlogWriter {
  ...
  static void onSpanExcluded(int spanID) { cur_binlog.write_event_type(EventTypeEnum::etSpanExclude, spanID); }
  ...
  static void onFuncAggregateBranch(int funcCallMask) { cur_binlog.write_event_type(EventTypeEnum::etFuncAggregateBranch, funcCallMask); }
  ...
  static void onCoroutineSwitchTo(int coroutineID) { cur_binlog.write_event_type(EventTypeEnum::etCoroutineSwitchTo, coroutineID); }
