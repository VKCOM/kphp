...
Optional<string> f$zstd_uncompress(const string& data) noexcept { return zstd_uncompress_impl(data); }

Optional<string> f$zstd_compress_dict(const string& data, const string& dict) noexcept { return zstd_compress_impl(data, DEFAULT_COMPRESS_LEVEL, dict); }

Optional<string> f$zstd_uncompress_dict(const string& data, const string& dict) noexcept { return zstd_uncompress_impl(data, dict); }
