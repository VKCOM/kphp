...
void tracing_binary_buffer::set_use_heap_memory() { use_heap_memory = true; }

void tracing_binary_buffer::init_and_alloc() { finish_cur_chunk_start_next(); }
...
void free_tracing_binlog_lib() { current_php_script_registered_strings.clear(); }
