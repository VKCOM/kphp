...
bool OomHandler::is_running() const noexcept { return callback_running_; }

void OomHandler::set_callback(on_oom_callback_t&& callback) noexcept { callback_ = std::move(callback); }
