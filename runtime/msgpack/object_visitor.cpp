...
object_visitor::object_visitor(msgpack::zone& zone) noexcept : m_zone(zone) {
...
void object_visitor::parse_error(size_t /*parsed_offset*/, size_t /*error_offset*/) const { throw msgpack::parse_error("parse error"); }
void object_visitor::insufficient_bytes(size_t /*parsed_offset*/, size_t /*error_offset*/) const { throw msgpack::insufficient_bytes("insufficient bytes"); }
