...
public:
  ...
  msgpack::object&& flush() && noexcept { return std::move(m_obj); }
  ...
  bool start_array_item() const noexcept { return true; }
  ...
  bool start_map_key() const noexcept { return true; }
  bool end_map_key() noexcept {
    ++m_stack.back();
    return true;
  }
  bool start_map_value() const noexcept { return true; }
