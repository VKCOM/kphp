...
static bool is_hll_unpacked(const string& hll) { return hll.empty() || (hll[0] != HLL_PACK_CHAR && hll[0] != HLL_PACK_CHAR_V2); }
...
bool f$vk_stats_hll_is_packed(const string& hll) { return !is_hll_unpacked(hll); }
