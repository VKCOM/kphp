...
public:
  ...
  bool does_need_compilation() const {
    ...
    // if not, regexp needs to be compiled every time in preg_match() and similar
...
Optional<int64_t> f$preg_match(const string& regex, const string& subject) { return f$preg_match(regexp(regex), subject); }

Optional<int64_t> f$preg_match_all(const string& regex, const string& subject) { return f$preg_match_all(regexp(regex), subject); }

Optional<int64_t> f$preg_match(const string& regex, const string& subject, mixed& matches) { return f$preg_match(regexp(regex), subject, matches); }

Optional<int64_t> f$preg_match_all(const string& regex, const string& subject, mixed& matches) { return f$preg_match_all(regexp(regex), subject, matches); }
...
Optional<int64_t> f$preg_match(const mixed& regex, const string& subject) { return f$preg_match(regexp(regex.to_string()), subject); }

Optional<int64_t> f$preg_match_all(const mixed& regex, const string& subject) { return f$preg_match_all(regexp(regex.to_string()), subject); }

Optional<int64_t> f$preg_match(const mixed& regex, const string& subject, mixed& matches) { return f$preg_match(regexp(regex.to_string()), subject, matches); }
...
int64_t f$preg_last_error() { return regexp::last_error(); }
