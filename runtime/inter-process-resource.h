...
public:
  ...
  uint32_t get_active_resource_id() const noexcept { return active_resource_id_; }

  uint32_t get_next_inactive_resource_id() const noexcept { return (active_resource_id_ + 1) % RESOURCE_AMOUNT; }
...
public:
  InterProcessResourceManager() noexcept : initiate_process_pid_{pid} {}
  ...
  void force_release_all_resources() noexcept { (*control_block_)->force_release_all_resources(); }
  ...
  bool is_initial_process() const noexcept { return initiate_process_pid_ == pid; }
