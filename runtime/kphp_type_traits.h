...
struct is_class_instance_inside<std::tuple<U, Ts...>>
  : std::integral_constant<bool, is_class_instance_inside<U>::value || is_class_instance_inside<std::tuple<Ts...>>::value> {};

template<size_t... Is, typename... Ts>
struct is_class_instance_inside<shape<std::index_sequence<Is...>, Ts...>> : is_class_instance_inside<std::tuple<Ts...>> {};
