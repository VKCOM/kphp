...
extern var (*addNewLogEvent_pointer) (string name, array <var> description, string engine, var from_id, var ip, var ua_hash, var remix_sid);
extern var (*logAddEvent_pointer) (string event_type, array <var> event, var uid, var ip_ulong, var ua_hash, var remix_sid, var port);
