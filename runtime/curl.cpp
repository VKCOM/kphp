...
static int curl_info_header_out (CURL *cp __attribute__((unused)), curl_infotype type, char *buf, size_t buf_len, void *userdata) {//TODO: this unused generated by script, recheck it.
  dl::leave_critical_section();//this is a callback called from curl_easy_perform
