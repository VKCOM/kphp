...
regexp::regexp(const string& regexp_string) { init(regexp_string); }

regexp::regexp(const char* regexp_string, int64_t regexp_len) { init(regexp_string, regexp_len); }
...
void global_init_regexp_lib() { regexp::global_init(); }
