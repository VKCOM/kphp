...
Optional<array<mixed>> f$DateTimeImmutable$$getLastErrors() noexcept { return php_timelib_date_get_last_errors(); }
...
int64_t f$DateTimeImmutable$$getOffset(const class_instance<C$DateTimeImmutable>& self) noexcept { return php_timelib_date_offset_get(self->time); }

int64_t f$DateTimeImmutable$$getTimestamp(const class_instance<C$DateTimeImmutable>& self) noexcept { return php_timelib_date_timestamp_get(self->time); }
