...
using ScriptMemGuard = decltype(std::function{make_malloc_replacement_with_script_allocator_guard})::result_type;
...
void free_timelib() {
  auto script_guard = make_malloc_replacement_with_script_allocator_guard();
