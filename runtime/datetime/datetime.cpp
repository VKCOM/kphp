...
Optional<array<mixed>> f$DateTime$$getLastErrors() noexcept { return php_timelib_date_get_last_errors(); }
...
int64_t f$DateTime$$getOffset(const class_instance<C$DateTime>& self) noexcept { return php_timelib_date_offset_get(self->time); }

int64_t f$DateTime$$getTimestamp(const class_instance<C$DateTime>& self) noexcept { return php_timelib_date_timestamp_get(self->time); }
