...
public:
  ...
  void read_int(int& v) noexcept { fi.read((char*)&v, sizeof(int)); }

  void read_uint32(uint32_t& v) noexcept { fi.read((char*)&v, sizeof(uint32_t)); }

  void read_uint64(uint64_t& v) noexcept { fi.read((char*)&v, sizeof(uint64_t)); }

  void read_float(float& v) noexcept { fi.read((char*)&v, sizeof(float)); }

  void read_double(double& v) noexcept { fi.read((char*)&v, sizeof(double)); }
  ...
  void read_bool(bool& v) noexcept { v = static_cast<bool>(read_int()); }

  void read_bytes(void* v, size_t len) noexcept { fi.read((char*)v, static_cast<std::streamsize>(len)); }
