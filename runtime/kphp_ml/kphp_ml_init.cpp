...
void init_kphp_ml_runtime_in_worker() { mutable_buffer_in_worker = new char[max_mutable_buffer_size]; }

char* kphp_ml_get_mutable_buffer_in_current_worker() { return mutable_buffer_in_worker; }
