...
int64_t f$mt_rand() noexcept { return f$mt_rand(0, f$mt_getrandmax()); }

int64_t f$mt_rand(int64_t l, int64_t r) noexcept { return MTRandGenerator::get().generate_random(l, r); }

void f$srand(int64_t seed) noexcept { f$mt_srand(seed); }

int64_t f$rand() noexcept { return f$mt_rand(); }

int64_t f$rand(int64_t l, int64_t r) noexcept { return f$mt_rand(l, r); }

int64_t f$getrandmax() noexcept { return f$mt_getrandmax(); }
...
void init_math_functions() noexcept { MTRandGenerator::get().lazy_init(); }
