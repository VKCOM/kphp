...
#include "runtime/runtime_types/string_cache.h"
...
string::string_inner *string::string_inner::create(size_type requested_capacity, size_type old_capacity) {
  ...
  string_inner *p = (string_inner *)platform::allocate(new_size);
  p->capacity = capacity;
  return p;
}
...
char *string::string_inner::reserve(size_type requested_capacity) {
  ...
  string_inner *p = (string_inner *)platform::reallocate((void *)this, new_size, old_size);
  p->capacity = new_cap;
  return p->ref_data();
}
...
void string::string_inner::destroy() {
  platform::deallocate(this, get_memory_usage());
}
