...
double divide (bool lhs, bool rhs __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
...
int f$memory_get_usage (bool real_usage __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
