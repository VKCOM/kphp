...
string& string::append (const var &v) {
  switch (v.type) {
    ...
    case var::STRING_TYPE:
      return append (*AS_CONST_STRING(v.s));
    case var::ARRAY_TYPE:
...
string& string::append_unsafe (const array <T, TT> &a __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
  php_warning ("Convertion from array to string");
...
string& string::assign (size_type n, bool b __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
  if (max_size < n) {
    php_critical_error ("tried to allocate too big string of size %lld", (long long)n);
  }
