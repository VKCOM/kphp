...
CompileTimeLocation f$CompileTimeLocation$$calculate(const CompileTimeLocation& v$passed) { return v$passed; }
...
void free_exception_lib() { hard_reset_var(CurException); }
