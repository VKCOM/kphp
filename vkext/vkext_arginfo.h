...
static const zend_function_entry ext_functions[] = {
  ZEND_FE(vk_hello_world, arginfo_vk_hello_world) ZEND_FE(vk_upcase, arginfo_vk_upcase) ZEND_FE(vk_utf8_to_win, arginfo_vk_utf8_to_win)
    ZEND_FE(vk_win_to_utf8, arginfo_vk_win_to_utf8) ZEND_FE(vk_flex, arginfo_vk_flex) ZEND_FE(vk_json_encode, arginfo_vk_json_encode)
      ZEND_FE(vk_whitespace_pack, arginfo_vk_whitespace_pack) ZEND_FE(new_rpc_connection, arginfo_new_rpc_connection) ZEND_FE(rpc_clean, arginfo_rpc_clean)
        ZEND_FE(rpc_send, arginfo_rpc_send) ZEND_FE(rpc_send_noflush, arginfo_rpc_send_noflush) ZEND_FE(rpc_flush, arginfo_rpc_flush)
          ZEND_FE(rpc_get_and_parse, arginfo_rpc_get_and_parse) ZEND_FE(rpc_get, arginfo_rpc_get) ZEND_FE(rpc_parse, arginfo_rpc_parse)
            ZEND_FE(set_fail_rpc_on_int32_overflow, arginfo_set_fail_rpc_on_int32_overflow) ZEND_FE(store_int, arginfo_store_int)
              ZEND_FE(store_long, arginfo_store_long) ZEND_FE(store_string, arginfo_store_string) ZEND_FE(store_double, arginfo_store_double)
                ZEND_FE(store_float, arginfo_store_float) ZEND_FE(store_many, arginfo_store_many) ZEND_FE(store_header, arginfo_store_header)
                  ZEND_FE(fetch_int, arginfo_fetch_int) ZEND_FE(fetch_long, arginfo_fetch_long) ZEND_FE(fetch_double, arginfo_fetch_double)
                    ZEND_FE(fetch_float, arginfo_fetch_float) ZEND_FE(fetch_string, arginfo_fetch_string)
                      ZEND_FE(fetch_memcache_value, arginfo_fetch_memcache_value) ZEND_FE(fetch_end, arginfo_fetch_end) ZEND_FE(fetch_eof, arginfo_fetch_eof)
                        ZEND_FE(fetch_lookup_int, arginfo_fetch_lookup_int) ZEND_FE(fetch_lookup_data, arginfo_fetch_lookup_data)
                          ZEND_FE(vk_set_error_verbosity, arginfo_vk_set_error_verbosity) ZEND_FE(rpc_queue_create, arginfo_rpc_queue_create)
                            ZEND_FE(rpc_queue_empty, arginfo_rpc_queue_empty) ZEND_FE(rpc_queue_next, arginfo_rpc_queue_next)
                              ZEND_FE(rpc_queue_push, arginfo_rpc_queue_push) ZEND_FE(vk_clear_stats, arginfo_vk_clear_stats)
                                ZEND_FE(rpc_tl_pending_queries_count, arginfo_rpc_tl_pending_queries_count) ZEND_FE(rpc_tl_query, arginfo_rpc_tl_query)
                                  ZEND_FE(rpc_tl_query_one, arginfo_rpc_tl_query_one) ZEND_FE(rpc_tl_query_result, arginfo_rpc_tl_query_result)
                                    ZEND_FE(rpc_tl_query_result_one, arginfo_rpc_tl_query_result_one) ZEND_FE(typed_rpc_tl_query, arginfo_typed_rpc_tl_query)
                                          ...
                                          ZEND_FE(typed_rpc_tl_query_result_one, arginfo_typed_rpc_tl_query_result_one)
                                            ZEND_FE(enable_internal_rpc_queries, arginfo_enable_internal_rpc_queries)
                                              ZEND_FE(disable_internal_rpc_queries, arginfo_disable_internal_rpc_queries)
                                                ZEND_FE(rpc_get_last_send_error, arginfo_rpc_get_last_send_error) ZEND_FE(vkext_prepare_stats,
                                                                                                                          arginfo_vkext_prepare_stats)
                                                  ZEND_FE(vkext_full_version, arginfo_vkext_full_version) ZEND_FE(vk_sp_simplify, arginfo_vk_sp_simplify)
                                                    ZEND_FE(vk_sp_full_simplify, arginfo_vk_sp_full_simplify) ZEND_FE(vk_sp_deunicode, arginfo_vk_sp_deunicode)
                                                      ZEND_FE(vk_sp_to_upper, arginfo_vk_sp_to_upper) ZEND_FE(vk_sp_to_lower, arginfo_vk_sp_to_lower)
                                                        ZEND_FE(vk_sp_sort, arginfo_vk_sp_sort) ZEND_FE(vk_sp_remove_repeats, arginfo_vk_sp_remove_repeats)
                                                                      ...
                                                                      ZEND_FE(vk_stats_hll_count, arginfo_vk_stats_hll_count)
                                                                        ZEND_FE(vk_stats_hll_pack, arginfo_vk_stats_hll_pack)
                                                                          ZEND_FE(vk_stats_hll_unpack, arginfo_vk_stats_hll_unpack)
                                                                            ZEND_FE(vk_stats_hll_is_packed, arginfo_vk_stats_hll_is_packed) ZEND_FE_END};
