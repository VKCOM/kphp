  ...
  switch ($lang_id) {
    ...
    case 0:
      ...
      $language_config['surnames'] = [
        ...
        [
          'patterns' => ['*', 'Хвин()', 'Иов()', 'Манчын()', 'Целестин()', 'Син()', 'Цын()'],
          'male'     => ['Gen' => 'а', 'Dat' => 'у', 'Acc' => 'а', 'Ins' => 'ом', 'Abl' => 'е'],
          'female'   => 'fixed',
        ],
        [
