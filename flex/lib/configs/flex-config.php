  ...
  switch ($lang_id) {
    ...
    case 0:
      ...
      $language_config['names'] = [
        ...
        [
          'patterns' => ['Али(я)', 'Нажи(я)', 'Гали(я)', 'Альфи(я)', 'Балхи(я)', 'Нури(я)', 'Зульфи(я)', 'Ади(я)', 'Кадри(я)', 'Дани(я)', 'Гвазба(я)', 'Зали(я)', 'Гульфи(я)', 'Руми(я)', 'Раушани(я)', 'Сани(я)', 'Рани(я)', 'Аси(я)', 'Нази(я)', 'Рамзи(я)'],
          'male'     => ['Gen' => 'и', 'Dat' => 'е', 'Acc' => 'ю', 'Ins' => 'ей', 'Abl' => 'е'],
          'female'   => ['Gen' => 'и', 'Dat' => 'е', 'Acc' => 'ю', 'Ins' => 'ей', 'Abl' => 'е'],
        ],
        [
        ...
        [
          'patterns' => ['*ок', '*що(к)', 'Альто(к)', 'Ено(к)'],
      ...
      $language_config['surnames'] = [
        ...
        [
          'patterns' => ['Тун-Куй-Сю', 'Мякеля', 'Лямся', 'Талья', 'Луя', 'Рейня', 'Ростобая', 'Пелля', 'Время', 'Орава', 'Лапика', 'Дега', 'Титма', 'Ковыла', 'Мантула', 'Прока', 'Олусаньа', 'Хун', 'Гетия', 'Ча', 'Ма', 'Ойя', 'Вака', 'Шайя', 'Шна', 'Лукка', 'Ха', 'Ю', 'Аль', 'Дя', 'Хестонна', 'И', 'Карвосеноя', 'Совесть', 'Осень', 'С', 'Навсегда', 'Нега', 'Гершпигель', 'Гершпигель', 'Хыа'],
          'male'     => 'fixed',
          'female'   => 'fixed',
        ],
        [
        ...
        [
          'patterns' => ['Сук', 'Гнеп', 'Кремс', 'Чан', 'Фа', 'Куст', 'Горох', 'Рысь', 'Лысь', 'Ша', 'А', 'О', 'У', 'Ухань', 'И', 'С', 'Кость', 'Выспотыкаетесь', 'Тилла', 'Авила', 'Дин У', 'Навсегда'],
          'male'     => 'fixed',
          'female'   => 'fixed',
        ],
        [
        ...
        [
          'patterns' => ['*а(ец)', '*е(ец)', '*и(ец)', '*о(ец)', '*у(ец)', '*ю(ец)', '*я(ец)', '*ы(ец)', '*ы(ец)'],
        ...
        [
          'patterns' => ['Шв(ец)', 'Жн(ец)', 'Игр(ец)', 'За(ец)', 'Б(ец)', 'Бразн(ец)', 'Гр(ец)', 'Ойн(ец)', 'Хейф(ец)', 'Х(ец)', 'Корни(ец)', 'Кн(ец)'],
        ...
        [
          'patterns' => ['*', 'Хвин()', 'Иов()', 'Манчын()', 'Целестин()'],
          'male'     => ['Gen' => 'а', 'Dat' => 'у', 'Acc' => 'а', 'Ins' => 'ом', 'Abl' => 'е'],
          'female'   => 'fixed',
        ],
        [
        ...
        [
          'patterns' => ['Тер-', 'Нор-', 'Сулима-', 'Бей-', 'Джан-', 'Гаген-', 'Крым-', 'И-', 'ген-', 'Сун-', 'Сун-дин-', 'дин-', 'Ин-', 'Ин-Дин-', 'Дин-', 'Бит-', 'Догуй-', 'Кызыл-', 'Аль-', 'Фон-', 'Шангыр-', '-оол()', 'Бадма-', 'дер-', 'Ван-', 'Ван-дер-', 'Ага-', 'ча-', 'Юн-', 'Эль-', '-Паш(а)', 'Ал-', 'Рза-', 'Бут-', 'Че-Гук-', 'Гук-', 'Алдын-', 'Чин-', 'Лин-Чин-', 'Дель-', 'Гуан-', 'Тин-', 'Гуан-Тин-', 'Ир-', 'Покинь-', 'Тилла', '&#1240;л-', 'Па-', 'Па-Ве-', 'Гехт-', 'Рефа', 'Сак-', 'Тун-Куй-', 'Тун-', 'Серин-', 'Цин-', 'Цин-Дэ-', 'Цин-дэ-', 'Я-', 'Я-о-', 'Я-О-', 'Аль-Сармини', 'Жан-', 'Ми-Чен-', 'Ми-Чен-', 'Ай-', 'На-Сы-', 'Ли-Шан-', 'Тя-Шен', 'Тя-Шен', 'Пак-Си', 'Ай-', 'Секерж-', 'Мелик-', 'Буд-', 'Ен-Шин-', 'Джек-'],
          'male'     => 'fixed',
          'female'   => 'fixed',
        ],
        [
