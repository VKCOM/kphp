  ...
  switch ($lang_id) {
    ...
    case 0:
      ...
      $language_config['surnames'] = [
        ...
        [
          'patterns' => ['Черношве(ц)', '*ец', 'Коре(ц)', 'Ое(ц)', 'Шке(ц)', 'Яре(ц)', 'Шле(ц)', 'Шпе(ц)', 'Марин(ец)', 'Фе(ц)'],
        ...
        [
          'patterns' => ['*', 'Хвин()', 'Иов()', 'Манчын()', 'Целестин()', 'Син()'],
          'male'     => ['Gen' => 'а', 'Dat' => 'у', 'Acc' => 'а', 'Ins' => 'ом', 'Abl' => 'е'],
          'female'   => 'fixed',
        ],
        [
