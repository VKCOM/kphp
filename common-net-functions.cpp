...
static int mc_connect_to_default (const char *host_name __attribute__((unused)), int port __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
  critical_error (__FUNCTION__);
}

static void mc_run_query_default (int host_num __attribute__((unused)), const char *request __attribute__((unused)), int request_len __attribute__((unused)), int timeout_ms __attribute__((unused)), int query_type __attribute__((unused)), void (*callback) (const char *result, int result_len) __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
  critical_error (__FUNCTION__);
}
...
static void db_run_query_default (int host_num __attribute__((unused)), const char *request __attribute__((unused)), int request_len __attribute__((unused)), int timeout_ms __attribute__((unused)), void (*callback) (const char *result, int result_len) __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
  critical_error (__FUNCTION__);
}


static void http_set_result_default (const char *headers __attribute__((unused)), int headers_len __attribute__((unused)), const char *body __attribute__((unused)), int body_len __attribute__((unused)), int exit_code __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
  critical_error (__FUNCTION__);
}

static int http_load_long_query_default (char *buf __attribute__((unused)), int min_len __attribute__((unused)), int max_len __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
  critical_error (__FUNCTION__);
}


static void set_server_status_default (const char *status __attribute__((unused)), int status_len __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
  critical_error (__FUNCTION__);
}
...
static void rpc_answer_default (const char *res __attribute__((unused)), int res_len __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
  critical_error (__FUNCTION__);
}

static void rpc_set_result_default (const char *body __attribute__((unused)), int body_len __attribute__((unused)), int exit_code __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
  critical_error (__FUNCTION__);
}
...
static int rpc_connect_to_default (const char *host_name __attribute__((unused)), int port __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
  critical_error (__FUNCTION__);
}

static slot_id_t rpc_send_query_default (int host_num __attribute__((unused)), char *request __attribute__((unused)), int request_len __attribute__((unused)), int timeout_ms __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
  critical_error (__FUNCTION__);
}

static void wait_net_events_default (int timeout_ms __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
  critical_error (__FUNCTION__);
}
...
static int query_x2_default (int x __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
  critical_error (__FUNCTION__);
}
