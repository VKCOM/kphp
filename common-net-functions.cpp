...
static int mc_connect_to_default (const char *host_name, int port) {
  critical_error (__FUNCTION__);
}

static void mc_run_query_default (int host_num, const char *request, int request_len, int timeout_ms, int query_type, void (*callback) (const char *result, int result_len)) {
  critical_error (__FUNCTION__);
}
...
static void db_run_query_default (int host_num, const char *request, int request_len, int timeout_ms, void (*callback) (const char *result, int result_len)) {
  critical_error (__FUNCTION__);
}


static void http_set_result_default (const char *headers, int headers_len, const char *body, int body_len, int exit_code) {
  critical_error (__FUNCTION__);
}

static int http_load_long_query_default (char *buf, int min_len, int max_len) {
  critical_error (__FUNCTION__);
}


static void set_server_status_default (const char *status, int status_len) {
  critical_error (__FUNCTION__);
}
...
static void rpc_answer_default (const char *res, int res_len) {
  critical_error (__FUNCTION__);
}

static void rpc_set_result_default (const char *body, int body_len, int exit_code) {
  critical_error (__FUNCTION__);
}
...
static int rpc_connect_to_default (const char *host_name, int port) {
  critical_error (__FUNCTION__);
}

static slot_id_t rpc_send_query_default (int host_num, char *request, int request_len, int timeout_ms) {
  critical_error (__FUNCTION__);
}
...
static int query_x2_default (int x) {
  critical_error (__FUNCTION__);
}
