...
int mcs_store(struct connection *c __attribute__((unused)), int op __attribute__((unused)), const char *key __attribute__((unused)),
              int key_len __attribute__((unused)), int flags __attribute__((unused)), int delay __attribute__((unused)), int size __attribute__((unused))) {
  return -2;
}
...
int mcs_get(struct connection *c __attribute__((unused)), const char *key __attribute__((unused)), int key_len __attribute__((unused))) {
  return 0;
}
...
int mcs_incr(struct connection *c, int op __attribute__((unused)), const char *key __attribute__((unused)), int key_len __attribute__((unused)),
