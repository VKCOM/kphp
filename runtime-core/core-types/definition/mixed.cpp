...
template <typename T>
static bool less_string_number_as_php8_impl(const string &lhs, T rhs) {
  auto lhs_float = 0.0;
...
template <typename T>
static bool less_number_string_as_php8(bool php7_result, T lhs, const string &rhs) {
...
template <typename T>
static bool less_string_number_as_php8(bool php7_result, const string &lhs, T rhs) {
  if (KphpCoreContext::current().show_migration_php8_warning & MIGRATION_PHP8_STRING_COMPARISON_FLAG) {
