...
typename array<T, Allocator>::key_type array<T, Allocator>::array_bucket::get_key() const {
  return string_key.is_dummy_string() ? key_type{int_key} : key_type{string_key};
}

template<class T, typename Allocator>
bool array<T, Allocator>::is_int_key(const typename array<T, Allocator>::key_type &key) {
  return key.is_int();
}

template<>
inline typename array<Unknown, DummyAllocator>::array_inner *array<Unknown, DummyAllocator>::array_inner::empty_array() {
  static array_inner_control empty_array{
    true, ExtraRefCnt::for_global_const, -1, {0, 0}, 0, 2,
  };
  return static_cast<array<Unknown, DummyAllocator>::array_inner *>(&empty_array);
}

template<class T, typename Allocator>
typename array<T, Allocator>::array_inner *array<T, Allocator>::array_inner::empty_array() {
  return reinterpret_cast<array_inner *>(array<Unknown, DummyAllocator>::array_inner::empty_array());
}

template<class T, typename Allocator>
uint32_t array<T, Allocator>::array_inner::choose_bucket(int64_t key) const noexcept {
  return choose_bucket(fields_for_map(), key);
}

template<class T, typename Allocator>
uint32_t array<T, Allocator>::array_inner::choose_bucket(const array_inner_fields_for_map &fields, int64_t key) const noexcept {
  return fastmod::fastmod_u32(static_cast<uint32_t>(key << 2), fields.modulo_helper_buf_size, buf_size);
}

template<class T, typename Allocator>
bool array<T, Allocator>::array_inner::is_vector() const noexcept {
  return is_vector_internal;
}

template<class T, typename Allocator>
typename array<T, Allocator>::list_hash_entry *array<T, Allocator>::array_inner::get_entry(entry_pointer_type pointer) const {
  return (list_hash_entry *)((char *)this + pointer);
  //  return pointer;
}

template<class T, typename Allocator>
typename array<T, Allocator>::entry_pointer_type array<T, Allocator>::array_inner::get_pointer(list_hash_entry *entry) const {
  return (entry_pointer_type)((char *)entry - (char *)this);
  //  return entry;
}

template<class T, typename Allocator>
const typename array<T, Allocator>::array_bucket *array<T, Allocator>::array_inner::begin() const {
  return (const array_bucket *)get_entry(last.next);
}

template<class T, typename Allocator>
const typename array<T, Allocator>::array_bucket *array<T, Allocator>::array_inner::next(const array_bucket *ptr) const {
  return (const array_bucket *)get_entry(ptr->next);
}

template<class T, typename Allocator>
const typename array<T, Allocator>::array_bucket *array<T, Allocator>::array_inner::prev(const array_bucket *ptr) const {
  return (const array_bucket *)get_entry(ptr->prev);
}

template<class T, typename Allocator>
const typename array<T, Allocator>::array_bucket *array<T, Allocator>::array_inner::end() const {
  return const_cast<array<T, Allocator>::array_inner *>(this)->end();
}

template<class T, typename Allocator>
typename array<T, Allocator>::array_bucket *array<T, Allocator>::array_inner::begin() {
  return (array_bucket *)get_entry(end()->next);
}

template<class T, typename Allocator>
typename array<T, Allocator>::array_bucket *array<T, Allocator>::array_inner::next(array_bucket *ptr) {
  return (array_bucket *)get_entry(ptr->next);
}

template<class T, typename Allocator>
typename array<T, Allocator>::array_bucket *array<T, Allocator>::array_inner::prev(array_bucket *ptr) {
  return (array_bucket *)get_entry(ptr->prev);
}

template<class T, typename Allocator>
typename array<T, Allocator>::array_bucket *array<T, Allocator>::array_inner::end() {
  return (array_bucket *)&last;
}

template<class T, typename Allocator>
bool array<T, Allocator>::array_inner::is_string_hash_entry(const array_bucket *ptr) const {
  return !ptr->string_key.is_dummy_string();
}

template<class T, typename Allocator>
typename array<T, Allocator>::array_inner_fields_for_map &array<T, Allocator>::array_inner::fields_for_map() {
  return *reinterpret_cast<array_inner_fields_for_map *>(reinterpret_cast<char *>(this) - sizeof(array_inner_fields_for_map));
}

template<class T, typename Allocator>
const typename array<T, Allocator>::array_inner_fields_for_map &array<T, Allocator>::array_inner::fields_for_map() const {
  return const_cast<array_inner *>(this)->fields_for_map();
}

template<class T, typename Allocator>
size_t array<T, Allocator>::array_inner::sizeof_vector(uint32_t int_size) noexcept {
  return sizeof(array_inner) + int_size * sizeof(T);
}

template<class T, typename Allocator>
size_t array<T, Allocator>::array_inner::sizeof_map(uint32_t int_size) noexcept {
  return sizeof(array_inner_fields_for_map) + sizeof(array_inner) + int_size * sizeof(array_bucket);
}

template<class T, typename Allocator>
size_t array<T, Allocator>::array_inner::estimate_size(int64_t &new_int_size, bool is_vector) {
...
template<class T, typename Allocator>
typename array<T, Allocator>::array_inner *array<T, Allocator>::array_inner::create(int64_t new_int_size, bool is_vector) {
  const size_t mem_size = estimate_size(new_int_size, is_vector);
  if (is_vector) {
    auto p = reinterpret_cast<array_inner *>(Allocator::allocate(mem_size));
  ...
  array_inner *p = shift_pointer_to_array_inner(Allocator::allocate0(mem_size));
...
template<class T, typename Allocator>
void array<T, Allocator>::array_inner::dispose() {
  if (ref_cnt < ExtraRefCnt::for_global_const) {
    ...
    if (ref_cnt <= -1) {
      if (is_vector()) {
        ...
        Allocator::deallocate((void *)this, sizeof_vector(buf_size));
        return;
      }
      ...
      Allocator::deallocate(shifted_this, sizeof_map(buf_size));
    }
  }
}

template<class T, typename Allocator>
typename array<T, Allocator>::array_inner *array<T, Allocator>::array_inner::ref_copy() {
  if (ref_cnt < ExtraRefCnt::for_global_const) {
    ref_cnt++;
  }
  return this;
...
template<class T, typename Allocator>
template<class... Args>
inline T &array<T, Allocator>::array_inner::emplace_back_vector_value(Args &&...args) noexcept {
...
template<class T, typename Allocator>
T &array<T, Allocator>::array_inner::push_back_vector_value(const T &v) {
  return emplace_back_vector_value(v);
}

template<class T, typename Allocator>
T &array<T, Allocator>::array_inner::get_vector_value(int64_t int_key) {
  return reinterpret_cast<T *>(entries)[int_key];
}

template<class T, typename Allocator>
const T &array<T, Allocator>::array_inner::get_vector_value(int64_t int_key) const {
  return reinterpret_cast<const T *>(entries)[int_key];
}

template<class T, typename Allocator>
template<class... Args>
T &array<T, Allocator>::array_inner::emplace_vector_value(int64_t int_key, Args &&...args) noexcept {
  static_assert(std::is_constructible<T, Args...>{}, "should be constructible");
...
template<class T, typename Allocator>
T &array<T, Allocator>::array_inner::set_vector_value(int64_t int_key, const T &v) {
  return emplace_vector_value(int_key, v);
}

template<class T, typename Allocator>
template<class... Args>
T &array<T, Allocator>::array_inner::emplace_int_key_map_value(overwrite_element policy, int64_t int_key, Args &&...args) noexcept {
  static_assert(std::is_constructible<T, Args...>{}, "should be constructible");
  uint32_t bucket = choose_bucket(int_key);
  while (entries[bucket].next != EMPTY_POINTER && (entries[bucket].int_key != int_key || !entries[bucket].string_key.is_dummy_string())) {
  ...
  if (entries[bucket].next == EMPTY_POINTER) {
    ...
    new (&entries[bucket].string_key) string<Allocator>{ArrayBucketDummyStrTag{}};
...
template<class T, typename Allocator>
T &array<T, Allocator>::array_inner::set_map_value(overwrite_element policy, int64_t int_key, const T &v) {
  return emplace_int_key_map_value(policy, int_key, v);
}

template<class T, typename Allocator>
T array<T, Allocator>::array_inner::unset_vector_value() {
  --size;
...
template<class T, typename Allocator>
T array<T, Allocator>::array_inner::unset_map_value(int64_t int_key) {
  uint32_t bucket = choose_bucket(int_key);
  while (entries[bucket].next != EMPTY_POINTER && (entries[bucket].int_key != int_key || !entries[bucket].string_key.is_dummy_string())) {
    if (unlikely(++bucket == buf_size)) {
      bucket = 0;
...
template<class T, typename Allocator>
template<class S>
auto &array<T, Allocator>::array_inner::find_map_entry(S &self, int64_t int_key) noexcept {
  uint32_t bucket = self.choose_bucket(int_key);
  while (self.entries[bucket].next != EMPTY_POINTER && (self.entries[bucket].int_key != int_key || !self.entries[bucket].string_key.is_dummy_string())) {
...
template<class T, typename Allocator>
template<class S>
auto &array<T, Allocator>::array_inner::find_map_entry(S &self, const string<Allocator> &string_key, int64_t precomputed_hash) noexcept {
...
auto &array<T, Allocator>::array_inner::find_map_entry(S &self, const char *key, typename string<Allocator>::size_type key_size, int64_t precomputed_hash) noexcept {
  ...
  while (string_entries[bucket].next != EMPTY_POINTER
         && (string_entries[bucket].int_key != precomputed_hash || string_entries[bucket].string_key.is_dummy_string()
             || str_not_eq(string_entries[bucket].string_key, key, key_size))) {
    if (unlikely(++bucket == self.buf_size)) {
      bucket = 0;
    }
  }
...
template<class T, typename Allocator>
template<class... Key>
const T *array<T, Allocator>::array_inner::find_map_value(Key &&...key) const noexcept {
  const auto &entry = find_map_entry(*this, std::forward<Key>(key)...);
  return entry.next != EMPTY_POINTER ? &entry.value : nullptr;
}

template<class T, typename Allocator>
const T *array<T, Allocator>::array_inner::find_vector_value(int64_t int_key) const noexcept {
  return int_key >= 0 && int_key < size ? &get_vector_value(int_key) : nullptr;
}

template<class T, typename Allocator>
T *array<T, Allocator>::array_inner::find_vector_value(int64_t int_key) noexcept {
  return int_key >= 0 && int_key < size ? &get_vector_value(int_key) : nullptr;
}

template<class T, typename Allocator>
template<class STRING, class... Args>
std::pair<T &, bool> array<T, Allocator>::array_inner::emplace_string_key_map_value(overwrite_element policy, int64_t int_key, STRING &&string_key,
                                                                                    Args &&...args) noexcept {
  static_assert(std::is_same<std::decay_t<STRING>, string<Allocator>>::value, "string_key should be string");
...
template<class T, typename Allocator>
T &array<T, Allocator>::array_inner::set_map_value(overwrite_element policy, int64_t int_key, const string<Allocator> &string_key, const T &v) {
  return emplace_string_key_map_value(policy, int_key, string_key, v).first;
}

template<class T, typename Allocator>
T array<T, Allocator>::array_inner::unset_map_value(const string<Allocator> &string_key, int64_t precomputed_hash) {
  array_bucket *string_entries = entries;
  auto &fields = fields_for_map();
...
template<class T, typename Allocator>
bool array<T, Allocator>::array_inner::is_vector_internal_or_last_index(int64_t key) const noexcept {
  return key >= 0 && key <= size;
}

template<class T, typename Allocator>
bool array<T, Allocator>::array_inner::has_no_string_keys() const noexcept {
  return is_vector_internal ? true : fields_for_map().string_size == 0;
}

template<class T, typename Allocator>
size_t array<T, Allocator>::array_inner::estimate_memory_usage() const noexcept {
  return is_vector() ? sizeof_vector(buf_size) : sizeof_map(buf_size);
}

template<class T, typename Allocator>
size_t array<T, Allocator>::array_inner::calculate_memory_for_copying() const noexcept {
...
template<class T, typename Allocator>
bool array<T, Allocator>::is_vector() const {
  return p->is_vector();
}

template<class T, typename Allocator>
bool array<T, Allocator>::is_pseudo_vector() const {
...
template<class T, typename Allocator>
bool array<T, Allocator>::has_no_string_keys() const noexcept {
  return p->has_no_string_keys();
}

template<class T, typename Allocator>
bool array<T, Allocator>::mutate_if_vector_shared(uint32_t mul) {
  return mutate_to_size_if_vector_shared(mul * int64_t{p->size});
}

template<class T, typename Allocator>
bool array<T, Allocator>::mutate_to_size_if_vector_shared(int64_t int_size) {
  if (p->ref_cnt > 0) {
...
template<class T, typename Allocator>
bool array<T, Allocator>::mutate_if_map_shared(uint32_t mul) {
  if (p->ref_cnt > 0) {
...
template<class T, typename Allocator>
void array<T, Allocator>::mutate_if_vector_needs_space() {
...
template<class T, typename Allocator>
void array<T, Allocator>::mutate_to_size(int64_t int_size) {
  ...
  p = static_cast<array_inner *>(Allocator::reallocate(p, p->sizeof_vector(new_int_buff_size), p->sizeof_vector(p->buf_size)));
  p->buf_size = new_int_buff_size;
}

template<class T, typename Allocator>
void array<T, Allocator>::mutate_if_map_needs_space() {
  ...
  if (p->size * 5 > 3 * p->buf_size) {
    ...
    for (array_bucket *it = p->begin(); it != p->end(); it = p->next(it)) {
      if (p->is_string_hash_entry(it)) {
        new_array->emplace_string_key_map_value(overwrite_element::YES, it->int_key, std::move(it->string_key), std::move(it->value));
      } else {
        new_array->emplace_int_key_map_value(overwrite_element::YES, it->int_key, std::move(it->value));
      }
    }
...
template<class T, typename Allocator>
void array<T, Allocator>::mutate_to_map_if_vector_or_map_need_space() {
  if (is_vector()) {
    convert_to_map();
  } else {
...
template<class T, typename Allocator>
void array<T, Allocator>::reserve(int64_t int_size, bool make_vector_if_possible) {
...
template<class T, typename Allocator>
size_t array<T, Allocator>::estimate_memory_usage() const noexcept {
  return p->estimate_memory_usage();
}

template<class T, typename Allocator>
size_t array<T, Allocator>::calculate_memory_for_copying() const noexcept {
...
template<class T, typename Allocator>
typename array<T, Allocator>::const_iterator array<T, Allocator>::middle(int64_t n) const {
...
template<class T, typename Allocator>
typename array<T, Allocator>::iterator array<T, Allocator>::middle(int64_t n) {
...
template<class T, typename Allocator>
void array<T, Allocator>::convert_to_map() {
...
template<class T, typename Allocator>
template<class T1>
void array<T, Allocator>::copy_from(const array<T1, Allocator> &other) {
  if (other.empty()) {
  ...
  if (new_array->is_vector()) {
    ...
    for (const typename array<T1, Allocator>::array_bucket *it = other.p->begin(); it != other.p->end(); it = other.p->next(it)) {
...
template<class T, typename Allocator>
template<class T1>
void array<T, Allocator>::move_from(array<T1, Allocator> &&other) noexcept {
  if (other.empty()) {
    p = array_inner::empty_array();
    return;
  }
  ...
  if (new_array->is_vector()) {
    ...
    for (auto it = other.p->begin(); it != other.p->end(); it = other.p->next(it)) {
      if (other.p->is_string_hash_entry(it)) {
        new_array->emplace_string_key_map_value(overwrite_element::YES, it->int_key, std::move(it->string_key), convert_to<T>::convert(std::move(it->value)));
      } else {
        new_array->emplace_int_key_map_value(overwrite_element::YES, it->int_key, convert_to<T>::convert(std::move(it->value)));
      }
    }
  }
...
template<class T, typename Allocator>
template<class U>
array<T, Allocator> array<T, Allocator>::convert_from(const array<U, Allocator> &other) {
  array<T, Allocator> res;
  res.copy_from(other);
  return res;
}
...
template<class T, typename Allocator>
array<T, Allocator>::array(const array_size &s)
  : p(array_inner::create(s.size, s.is_vector)) {}

template<class T, typename Allocator>
template<class KeyT>
inline array<T, Allocator>::array(const std::initializer_list<std::pair<KeyT, T>> &list)
  : array() {
...
template<class T, typename Allocator>
array<T, Allocator>::array(const array<T, Allocator> &other) noexcept
  : p(other.p->ref_copy()) {}

template<class T, typename Allocator>
array<T, Allocator>::array(array<T, Allocator> &&other) noexcept
  : p(other.p) {
...
array<T, Allocator>::array(const array<T1, Allocator> &other) noexcept {
  copy_from(other);
}

template<class T, typename Allocator>
template<class T1, class>
array<T, Allocator>::array(array<T1, Allocator> &&other) noexcept {
  move_from(std::move(other));
}

template<class T, typename Allocator>
template<class... Args>
inline array<T, Allocator> array<T, Allocator>::create(Args &&...args) {
  static_assert((std::is_convertible<std::decay_t<Args>, T>::value && ...), "Args type must be convertible to T");

  array<T, Allocator> res{array_size{sizeof...(args), true}};
  (res.p->emplace_back_vector_value(std::forward<Args>(args)), ...);
  return res;
}

template<class T, typename Allocator>
array<T, Allocator> &array<T, Allocator>::operator=(const array &other) noexcept {
...
template<class T, typename Allocator>
template<class T1, class>
array<T, Allocator> &array<T, Allocator>::operator=(const array<T1, Allocator> &other) noexcept {
  destroy();
  copy_from(other);
  return *this;
}
...
template<class T, typename Allocator>
template<class T1, class>
array<T, Allocator> &array<T, Allocator>::operator=(array<T1, Allocator> &&other) noexcept {
  destroy();
  move_from(std::move(other));
  return *this;
}
...
template<class T, typename Allocator>
void array<T, Allocator>::destroy() {
  if (p) {
    p->dispose();
  }
}
...
template<class T, typename Allocator>
T &array<T, Allocator>::operator[](int64_t int_key) {
  if (is_vector()) {
...
template<class T, typename Allocator>
T &array<T, Allocator>::operator[](const string<Allocator> &string_key) {
  int64_t int_val = 0;
...
template<class T, typename Allocator>
T &array<T, Allocator>::operator[](tmp_string<Allocator> string_key) {
  // TODO: try not to allocate here too
  return (*this)[materialize_tmp_string(string_key)];
}

template<class T, typename Allocator>
T &array<T, Allocator>::operator[](const mixed<Allocator> &v) {
  switch (v.get_type()) {
...
template<class T, typename Allocator>
T &array<T, Allocator>::operator[](double double_key) {
  return (*this)[static_cast<int64_t>(double_key)];
}

template<class T, typename Allocator>
T &array<T, Allocator>::operator[](const const_iterator &it) noexcept {
...
template<class T, typename Allocator>
T &array<T, Allocator>::operator[](const iterator &it) noexcept {
  return operator[](const_iterator{it.self_, it.entry_});
}

template<class T, typename Allocator>
template<class... Args>
void array<T, Allocator>::emplace_value(int64_t int_key, Args &&...args) noexcept {
  if (is_vector()) {
    if (p->is_vector_internal_or_last_index(int_key)) {
      if (int_key == p->size) {
        mutate_if_vector_needs_space();
...
template<class T, typename Allocator>
void array<T, Allocator>::set_value(int64_t int_key, T &&v) noexcept {
  emplace_value(int_key, std::move(v));
}

template<class T, typename Allocator>
void array<T, Allocator>::set_value(int64_t int_key, const T &v) noexcept {
  emplace_value(int_key, v);
}

template<class T, typename Allocator>
void array<T, Allocator>::set_value(double double_key, T &&v) noexcept {
  emplace_value(static_cast<int64_t>(double_key), std::move(v));
}

template<class T, typename Allocator>
void array<T, Allocator>::set_value(double double_key, const T &v) noexcept {
  emplace_value(static_cast<int64_t>(double_key), v);
}

template<class T, typename Allocator>
template<class... Args>
void array<T, Allocator>::emplace_value(const string<Allocator> &string_key, Args &&...args) noexcept {
  int64_t int_val = 0;
  if (string_key.try_to_int(&int_val)) {
  ...
  mutate_to_map_if_vector_or_map_need_space();
  p->emplace_string_key_map_value(overwrite_element::YES, string_key.hash(), string_key, std::forward<Args>(args)...);
}

template<class T, typename Allocator>
void array<T, Allocator>::set_value(const string<Allocator> &string_key, T &&v) noexcept {
  emplace_value(string_key, std::move(v));
}

template<class T, typename Allocator>
void array<T, Allocator>::set_value(const string<Allocator> &string_key, const T &v) noexcept {
  emplace_value(string_key, v);
}

template<class T, typename Allocator>
void array<T, Allocator>::set_value(tmp_string<Allocator> string_key, T &&v) noexcept {
...
template<class T, typename Allocator>
void array<T, Allocator>::set_value(tmp_string<Allocator> string_key, const T &v) noexcept {
  // TODO: rework value insertion, so tmp_string is converted to a real string
  // only when new insertion happens
...
template<class T, typename Allocator>
void array<T, Allocator>::set_value(const string<Allocator> &string_key, const T &v, int64_t precomputed_hash) noexcept {
  mutate_to_map_if_vector_or_map_need_space();
  p->emplace_string_key_map_value(overwrite_element::YES, precomputed_hash, string_key, v);
}

template<class T, typename Allocator>
void array<T, Allocator>::set_value(const string<Allocator> &string_key, T &&v, int64_t precomputed_hash) noexcept {
  mutate_to_map_if_vector_or_map_need_space();
...
template<class T, typename Allocator>
template<class... Args>
void array<T, Allocator>::emplace_value(const mixed<Allocator> &var_key, Args &&...args) noexcept {
  switch (var_key.get_type()) {
    case mixed<Allocator>::type::NUL:
      return emplace_value(string<Allocator>(), std::forward<Args>(args)...);
    case mixed<Allocator>::type::BOOLEAN:
...
template<class T, typename Allocator>
void array<T, Allocator>::set_value(const mixed<Allocator> &v, T &&value) noexcept {
  emplace_value(v, std::move(value));
}

template<class T, typename Allocator>
void array<T, Allocator>::set_value(const mixed<Allocator> &v, const T &value) noexcept {
  emplace_value(v, value);
}

template<class T, typename Allocator>
template<class OptionalT, class... Args>
void array<T, Allocator>::emplace_value(const Optional<OptionalT> &key, Args &&...args) noexcept {
...
void array<T, Allocator>::set_value(const Optional<OptionalT> &key, T &&value) noexcept {
  emplace_value(key, std::move(value));
}

template<class T, typename Allocator>
template<class OptionalT>
void array<T, Allocator>::set_value(const Optional<OptionalT> &key, const T &value) noexcept {
  emplace_value(key, value);
}

template<class T, typename Allocator>
void array<T, Allocator>::set_value(const const_iterator &it) noexcept {
  if (it.self_->is_vector()) {
    const auto key = static_cast<int64_t>(reinterpret_cast<const T *>(it.entry_) - reinterpret_cast<const T *>(it.self_->entries));
...
template<class T, typename Allocator>
void array<T, Allocator>::set_value(const iterator &it) noexcept {
  set_value(const_iterator{it.self_, it.entry_});
}

template<class T, typename Allocator>
void array<T, Allocator>::assign_raw(const char *s) {
  p = reinterpret_cast<array_inner *>(const_cast<char *>(s));
}

template<class T, typename Allocator>
const T *array<T, Allocator>::find_value(int64_t int_key) const noexcept {
  return p->is_vector() ? p->find_vector_value(int_key) : p->find_map_value(int_key);
}
...
template<class T, typename Allocator>
const T *array<T, Allocator>::find_value(const string<Allocator> &string_key, int64_t precomputed_hash) const noexcept {
  return p->is_vector() ? nullptr : p->find_map_value(string_key, precomputed_hash);
}

template<class T, typename Allocator>
const T *array<T, Allocator>::find_value(const mixed<Allocator> &v) const noexcept {
  switch (v.get_type()) {
    case mixed<Allocator>::type::NUL:
      return find_value(string<Allocator>());
    case mixed<Allocator>::type::BOOLEAN:
...
template<class T, typename Allocator>
const T *array<T, Allocator>::find_value(double double_key) const noexcept {
  return find_value(static_cast<int64_t>(double_key));
}

template<class T, typename Allocator>
const T *array<T, Allocator>::find_value(const const_iterator &it) const noexcept {
  if (it.self_->is_vector()) {
    const auto key = static_cast<int64_t>(reinterpret_cast<const T *>(it.entry_) - reinterpret_cast<const T *>(it.self_->entries));
    return find_value(key);
  } else {
    auto *entry = reinterpret_cast<const array_bucket *>(it.entry_);
    return it.self_->is_string_hash_entry(entry) ? find_value(entry->string_key, entry->int_key) : find_value(entry->int_key);
  }
}

template<class T, typename Allocator>
const T *array<T, Allocator>::find_value(const iterator &it) const noexcept {
  return find_value(const_iterator{it.self_, it.entry_});
}

template<class T, typename Allocator>
typename array<T, Allocator>::iterator array<T, Allocator>::find_no_mutate(int64_t int_key) noexcept {
  if (p->is_vector()) {
...
template<class T, typename Allocator>
typename array<T, Allocator>::iterator array<T, Allocator>::find_no_mutate(const string<Allocator> &string_key) noexcept {
  int64_t int_key = 0;
...
template<class T, typename Allocator>
template<class... Key>
typename array<T, Allocator>::iterator array<T, Allocator>::find_iterator_in_map_no_mutate(const Key &...key) noexcept {
...
template<class T, typename Allocator>
typename array<T, Allocator>::iterator array<T, Allocator>::find_no_mutate(const mixed<Allocator> &v) noexcept {
  switch (v.get_type()) {
    case mixed<Allocator>::type::NUL:
      return find_no_mutate(string<Allocator>());
    case mixed<Allocator>::type::BOOLEAN:
...
template<class T, typename Allocator>
template<class K>
const mixed<Allocator> array<T, Allocator>::get_var(const K &key) const {
  auto *value = find_value(key);
  return value ? mixed<Allocator>{*value} : mixed<Allocator>{};
}

template<class T, typename Allocator>
template<class K>
const T array<T, Allocator>::get_value(const K &key) const {
  auto *value = find_value(key);
  return value ? *value : T{};
}

template<class T, typename Allocator>
const T array<T, Allocator>::get_value(const string<Allocator> &string_key, int64_t precomputed_hash) const {
...
template<class T, typename Allocator>
template<class K>
bool array<T, Allocator>::has_key(const K &key) const {
  return find_value(key) != nullptr;
}

template<class T, typename Allocator>
template<class K>
bool array<T, Allocator>::isset(const K &key) const noexcept {
  auto *value = find_value(key);
  return value && !f$is_null(*value);
}

template<class T, typename Allocator>
bool array<T, Allocator>::isset(const string<Allocator> &key, int64_t precomputed_hash) const noexcept {
  auto *value = find_value(key, precomputed_hash);
  return value && !f$is_null(*value);
}

template<class T, typename Allocator>
T array<T, Allocator>::unset(int64_t int_key) {
  if (is_vector()) {
...
template<class T, typename Allocator>
T array<T, Allocator>::unset(const string<Allocator> &string_key) {
  int64_t int_val = 0;
  if (string_key.try_to_int(&int_val)) {
...
template<class T, typename Allocator>
T array<T, Allocator>::unset(const string<Allocator> &string_key, int64_t precomputed_hash) {
  if (is_vector()) {
    return {};
  }
...
template<class T, typename Allocator>
T array<T, Allocator>::unset(const mixed<Allocator> &v) {
  switch (v.get_type()) {
    case mixed<Allocator>::type::NUL:
      return unset(string<Allocator>());
    case mixed<Allocator>::type::BOOLEAN:
...
template<class T, typename Allocator>
int64_t array<T, Allocator>::count() const {
  return p->size;
}

template<class T, typename Allocator>
array_size array<T, Allocator>::size() const {
  return {p->size, is_vector()};
}

template<class T, typename Allocator>
template<class T1, class>
void array<T, Allocator>::merge_with(const array<T1, Allocator> &other) noexcept {
  for (auto it : other) {
...
template<class T, typename Allocator>
template<class T1, class>
void array<T, Allocator>::merge_with_recursive(const array<T1, Allocator> &other) noexcept {
  for (auto it : other) {
...
template<class T, typename Allocator>
void array<T, Allocator>::merge_with_recursive(const mixed<Allocator> &other) noexcept {
  if (other.is_array()) {
    return merge_with_recursive(other.as_array());
  }
  if constexpr (std::is_convertible_v<mixed<Allocator>, T>) {
    merge_with_recursive(array<T, Allocator>::create(other));
  } else {
...
template<class T, typename Allocator>
const array<T, Allocator> array<T, Allocator>::operator+(const array<T, Allocator> &other) const {
  ...
  array<T, Allocator> result(size() + other.size());
  ...
  if (is_vector()) {
    if (other.is_vector()) {
      ...
      if (p->ref_cnt > 0) {
        ...
        p = (array_inner *)static_cast<array_inner *>(Allocator::reallocate((void *)p, p->sizeof_vector(new_size), p->sizeof_vector(p->buf_size)));
        p->buf_size = new_size;
      }
...
template<class T, typename Allocator>
template<class... Args>
T &array<T, Allocator>::emplace_back(Args &&...args) noexcept {
  if (is_vector()) {
    mutate_if_vector_needs_space();
...
template<class T, typename Allocator>
void array<T, Allocator>::push_back(T &&v) noexcept {
  emplace_back(std::move(v));
}

template<class T, typename Allocator>
void array<T, Allocator>::push_back(const T &v) noexcept {
  emplace_back(v);
}

template<class T, typename Allocator>
template<merge_recursive recursive>
std::enable_if_t<recursive == merge_recursive::YES> array<T, Allocator>::start_merge_recursive(T &value, bool was_inserted, const T &other_value) noexcept {
  static_assert(std::is_same_v<T, mixed<Allocator>>);
  if (!was_inserted) {
    if (!value.is_array()) {
      value = array<T, Allocator>::create(value);
    }
...
void array<T, Allocator>::push_back_iterator(const array_iterator<T1, Allocator> &it) noexcept {
  if (it.self_->is_vector()) {
    emplace_back(*reinterpret_cast<const T1 *>(it.entry_));
  } else {
    auto *entry = reinterpret_cast<typename array_iterator<T1, Allocator>::bucket_type *>(it.entry_);
    if (it.self_->is_string_hash_entry(entry)) {
      mutate_to_map_if_vector_or_map_need_space();

      // don't overwrite existing element if we are in merge_recursive::YES mode,
      // this case will be handled further
      auto [value_ref, inserted] = p->emplace_string_key_map_value(recursive == merge_recursive::YES ? overwrite_element::NO : overwrite_element::YES,
...
template<class T, typename Allocator>
void array<T, Allocator>::push_back(const const_iterator &it) noexcept {
  push_back_iterator(it);
}

template<class T, typename Allocator>
void array<T, Allocator>::push_back(const iterator &it) noexcept {
  push_back_iterator(it);
}

template<class T, typename Allocator>
const T array<T, Allocator>::push_back_return(const T &v) {
  return emplace_back(v);
}

template<class T, typename Allocator>
const T array<T, Allocator>::push_back_return(T &&v) {
  return emplace_back(std::move(v));
}

template<class T, typename Allocator>
void array<T, Allocator>::swap_int_keys(int64_t idx1, int64_t idx2) noexcept {
  if (idx1 == idx2) {
    return;
  }
...
template<class T, typename Allocator>
void array<T, Allocator>::fill_vector(int64_t num, const T &value) {
...
template<class T, typename Allocator>
void array<T, Allocator>::memcpy_vector(int64_t num __attribute__((unused)), const void *src_buf __attribute__((unused))) {
...
template<class T, typename Allocator>
int64_t array<T, Allocator>::get_next_key() const {
  return p->max_key + 1;
}

template<class T, typename Allocator>
template<class T1>
void array<T, Allocator>::sort(const T1 &compare, bool renumber) {
  int64_t n = count();
  ...
  if (renumber) {
    ...
    const auto elements_cmp = [&compare](const T &lhs, const T &rhs) { return compare(lhs, rhs) > 0; };
  ...
  const auto hash_entry_cmp = [&compare](const array_bucket *lhs, const array_bucket *rhs) { return compare(lhs->value, rhs->value) > 0; };
  ...
  Allocator::deallocate(arTmp, n * sizeof(array_bucket *));
}

template<class T, typename Allocator>
template<class T1>
void array<T, Allocator>::ksort(const T1 &compare) {
  int64_t n = count();
  if (n <= 1) {
    return;
  }
  ...
  array<key_type, Allocator> keys(array_size(n, true));
...
template<class T, typename Allocator>
void array<T, Allocator>::swap(array<T, Allocator> &other) {
  array_inner *tmp = p;
  p = other.p;
  other.p = tmp;
}
...
T array<T, Allocator>::pop() {
  ...
  return p->is_string_hash_entry(it) ? p->unset_map_value(it->string_key, it->int_key) : p->unset_map_value(it->int_key);
}
...
template<class T, typename Allocator>
int64_t array<T, Allocator>::unshift(const T &val) {
  if (is_vector()) {
    mutate_if_vector_needs_space();
...
template<class T, typename Allocator>
bool array<T, Allocator>::to_bool() const {
  return static_cast<bool>(count());
}

template<class T, typename Allocator>
int64_t array<T, Allocator>::to_int() const {
  return count();
}

template<class T, typename Allocator>
double array<T, Allocator>::to_float() const {
  return static_cast<double>(count());
}

template<class T, typename Allocator>
int64_t array<T, Allocator>::get_reference_counter() const {
  return p->ref_cnt + 1;
}

template<class T, typename Allocator>
bool array<T, Allocator>::is_reference_counter(ExtraRefCnt ref_cnt_value) const noexcept {
  return p->ref_cnt == ref_cnt_value;
}

template<class T, typename Allocator>
void array<T, Allocator>::set_reference_counter_to(ExtraRefCnt ref_cnt_value) noexcept {
...
template<class T, typename Allocator>
void array<T, Allocator>::force_destroy(ExtraRefCnt expected_ref_cnt) noexcept {
...
template<class T, typename Allocator>
typename array<T, Allocator>::iterator array<T, Allocator>::begin_no_mutate() {
  if (is_vector()) {
    return typename array<T, Allocator>::iterator(p, p->entries);
  }
  return typename array<T, Allocator>::iterator(p, p->begin());
}

template<class T, typename Allocator>
typename array<T, Allocator>::iterator array<T, Allocator>::end_no_mutate() {
  return end();
}

template<class T, typename Allocator>
void array<T, Allocator>::mutate_if_shared() noexcept {
  if (is_vector()) {
    mutate_if_vector_shared();
  } else {
    mutate_if_map_shared();
...
template<class T, typename Allocator>
const T *array<T, Allocator>::get_const_vector_pointer() const {
  php_assert(is_vector());
  return &(p->get_vector_value(0));
}

template<class T, typename Allocator>
T *array<T, Allocator>::get_vector_pointer() {
  php_assert(is_vector());
  return &(p->get_vector_value(0));
}

template<class T, typename Allocator>
bool array<T, Allocator>::is_equal_inner_pointer(const array &other) const noexcept {
  return p == other.p;
}
}

template<class T, typename Allocator>
void swap(__array<T, Allocator> &lhs, __array<T, Allocator> &rhs) {
  lhs.swap(rhs);
}

template<class T, typename Allocator>
const __array<T, Allocator> array_add(__array<T, Allocator> a1, const __array<T, Allocator> &a2) {
  return a1 += a2;
}