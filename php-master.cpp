...
int php_master_get_end (struct connection *c, int key_cnt __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
  if (c->status != conn_wait_net) {
    write_out (&c->Out, "END\r\n", 5);
  }
  return 0;
...
int signal_epoll_handler (int fd __attribute__((unused)), void *data __attribute__((unused)), event_t *ev __attribute__((unused))) {//TODO: this unused generated by script, recheck it.
  //empty
