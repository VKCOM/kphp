...
int main(int argc, char* argv[]) {
  ...
  parser.add("List of builtins whose calls need to be tracked", settings->tracked_builtins_list, "tracked-builtins-list", "KPHP_TRACKED_BUILTINS_LIST");
  ...
  parser.add("The output binary type: server, cli, lib, k2-lib, k2-cli, k2-server, k2-oneshot, k2-multishot", settings->mode, 'M', "mode", "KPHP_MODE",
             "server", {"server", "cli", "lib", "k2-lib", "k2-cli", "k2-server", "k2-oneshot", "k2-multishot"});
  ...
  parser.add("Number of file buckets", settings->file_buckets_count, "file-buckets-count", "KPHP_FILE_BUCKETS_COUNT", "120");
  ...
  parser.add("Specify the compiled php code commit hash", settings->php_code_commit_hash, "php-code-commit-hash", "KPHP_PHP_CODE_COMMIT_HASH",
