...
void Stats::write_to(std::ostream &out, bool with_indent) const {
  ...
  out << block_sep;
  out << indent << "hash_tables.max_files: " << ht_max_files << std::endl;
  out << indent << "hash_tables.total_files: " << ht_total_files << std::endl;
  out << indent << "hash_tables.max_dirs: " << ht_max_dirs << std::endl;
  out << indent << "hash_tables.total_dirs: " << ht_total_dirs << std::endl;
  out << indent << "hash_tables.max_functions: " << ht_max_functions << std::endl;
  out << indent << "hash_tables.total_functions: " << ht_total_functions << std::endl;
  out << indent << "hash_tables.max_classes: " << ht_max_classes << std::endl;
  out << indent << "hash_tables.total_classes: " << ht_total_classes + total_lambdas << std::endl;
  out << indent << "hash_tables.max_defines: " << ht_max_defines << std::endl;
  out << indent << "hash_tables.total_defines: " << ht_total_defines << std::endl;
  out << indent << "hash_tables.max_constants: " << ht_max_constants << std::endl;
  out << indent << "hash_tables.total_constants: " << ht_total_constants << std::endl;
  out << indent << "hash_tables.max_globals: " << ht_max_globals << std::endl;
  out << indent << "hash_tables.total_globals: " << ht_total_globals << std::endl;
  out << indent << "hash_tables.max_libs: " << ht_max_libs << std::endl;
  out << indent << "hash_tables.total_libs: " << ht_total_libs << std::endl;
  out << indent << "hash_tables.max_modulites: " << ht_max_modulites << std::endl;
  out << indent << "hash_tables.total_modulites: " << ht_total_modulites << std::endl;
  out << indent << "hash_tables.max_composer_jsons: " << ht_max_composer_jsons << std::endl;
