...
public:
  ...
  bool is_static() const {
    return scope_modifier_ == ScopeModifiers::static_;
  }
  bool is_instance() const {
    return scope_modifier_ == ScopeModifiers::instance_;
  }
  bool is_nonmember() const {
    return !is_static() && !is_instance();
  }

  bool is_static_lambda() const {
    return scope_modifier_ == ScopeModifiers::static_lambda_;
  }
  ...
  friend bool operator==(const FunctionModifiers &lhs, const FunctionModifiers &rhs) {
    return lhs.abstract_modifier_ == rhs.abstract_modifier_ && lhs.scope_modifier_ == rhs.scope_modifier_ && lhs.access_modifier_ == rhs.access_modifier_;
  }
