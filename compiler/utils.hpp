...
MapToId<KeyT, EntryT>::MapToId(Enumerator<EntryT> *items) :
  items(items) {
}

template<typename KeyT, typename EntryT>
int MapToId<KeyT, EntryT>::get_id(const KeyT &name) {
...
template<typename KeyT, typename EntryT>
int MapToId<KeyT, EntryT>::add_name(const KeyT &name, const EntryT &add) {
...
template<typename KeyT, typename EntryT>
EntryT &MapToId<KeyT, EntryT>::operator[](int id) {
  return (*items)[id];
}

template<typename KeyT, typename EntryT>
set<int> MapToId<KeyT, EntryT>::get_ids() {
  set<int> res;
