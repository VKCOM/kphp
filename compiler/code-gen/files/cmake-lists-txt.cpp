...
add_executable(dummy EXCLUDE_FROM_ALL ${SRC_FILES})
target_include_directories(dummy PRIVATE . ${AUTO_DIR}/runtime/)
target_link_libraries(dummy PRIVATE ${RUNTIME_LIBS} ${RUNTIME_LINK_TEST_LIBS}))cmake";
