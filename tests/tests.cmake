if(KPHP_TESTS)
    function(vk_add_unittest TEST_NAME SRC_LIBS)
        ...
        target_link_libraries(${TEST_NAME} PRIVATE GTest::GTest GTest::Main GTest::gmock ${SRC_LIBS} vk::${PIC_MODE}::popular-common)
    ...
    if (COMPILE_RUNTIME_LIGHT)
        include(tests/cpp/runtime-light/runtime-light-tests.cmake)
    else ()
