...
function basic_test() {
    ...
    var_dump(array_diff_assoc($array2, $array3));
    var_dump(array_diff_assoc($array1, $array2, $array3));
}
...
function variation_array_test() {
    ...
    var_dump(array_diff_assoc([0, 1, 12345, -2345], $array));
    var_dump(array_diff_assoc([10.5, -10.5, 12.3456789000e10, 12.3456789000E-10, .5], $array));
    var_dump(array_diff_assoc([NULL, null], $array));
    var_dump(array_diff_assoc([true, false, TRUE, FALSE], $array));
    var_dump(array_diff_assoc(["", ''], $array));
    var_dump(array_diff_assoc(["string"], $array));
    var_dump(array_diff_assoc([@$unset_var], $array));
}
...
function variation_map_keys_type1_test() {
    ...
    var_dump(array_diff_assoc([NULL => 'null 1', null => 'null 2'], $array));
    var_dump(array_diff_assoc(["" => 'emptyd', '' => 'emptys'], $array));
    var_dump(array_diff_assoc(["string" => 'stringd', 'string' => 'strings'], $array));
    var_dump(array_diff_assoc([@$unset_var => 'unset'], $array));
}

function variation_map_keys_type2_test() {
    $array = ['zero', 1 => 1, 'two' => 2.00000000000001];

    var_dump(array_diff_assoc(['2.00000000000001', '1', 'zero', 'a'], $array));
    var_dump(array_diff_assoc([2 => '2.00000000000001', 1 => '1', 0 => 'zero', 3 => 'a'], $array));
    var_dump(array_diff_assoc(['2' => '2.00000000000001', '1' => '1', '0' => 'zero', '3' => 'a'], $array));
    var_dump(array_diff_assoc([2, 1, 0], $array));
    var_dump(array_diff_assoc([2 => 2, 1 => 1, 0 => 0], $array));
    var_dump(array_diff_assoc(['two' => 2, '1' => 1, '0' => 0], $array));
    var_dump(array_diff_assoc([2.00000000000001, 1.00, 0.01E-9], $array));
    var_dump(array_diff_assoc([2 => 2.00000000000001, 1 =>  1.00, 0 => 0.01E-9], $array));
    var_dump(array_diff_assoc(['two' => 2.00000000000001, '1' => 1.00, '0' =>0.01E-9], $array));
}
...
function variation_usage_test() {
    ...
    var_dump(array_diff_assoc($arr_default_int, $arr_float, $arr_string));
    var_dump(array_diff_assoc($arr_default_int, $arr_float, $arr_string_float));
    var_dump(array_diff_assoc($arr_default_int, $arr_string, $arr_string_float));
    var_dump(array_diff_assoc($arr_float, $arr_string, $arr_string_float));
}
