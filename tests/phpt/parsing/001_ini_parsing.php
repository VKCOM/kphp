...
function test_parse_ini_string_values($ini_string) {
    var_dump(parse_ini_string($ini_string), false);
    var_dump(parse_ini_string($ini_string), true);
}
...
test_parse_ini_string_values($ini);
