...
if __name__ == "__main__":
    ...
    runner.add_test_group(
        ...
        cmd="RUST_LOG=debug K2_HTTP_REQUEST_TIMEOUT=2 KPHP_TESTS_POLYFILLS_REPO={kphp_polyfills_repo} KPHP_CXX={cxx_name} K2_BIN={k2_bin} python3 -m pytest --basetemp={base_tempdir} --tb=native -n10 {functional_tests_dir}".format(
            kphp_polyfills_repo=kphp_polyfills_repo,
            cxx_name=args.cxx_name,
            k2_bin=args.k2_bin,
            jobs=n_cpu,
        ...
        skip=not args.k2_bin or (args.steps and "k2-functional-tests" not in args.steps),
    )
