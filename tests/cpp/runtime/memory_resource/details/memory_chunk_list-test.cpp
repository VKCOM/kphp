...
TEST(unsynchronized_memory_chunk_list_test, empty) {
  memory_resource::details::unsynchronized_memory_chunk_list mem_chunk_list;
...
TEST(synchronized_memory_chunk_list_test, empty) {
  memory_resource::details::synchronized_memory_chunk_list mem_chunk_list;
  ASSERT_EQ(mem_chunk_list.get_mem(), nullptr);
}

TEST(synchronized_memory_chunk_list_test, put_get_mem) {
  memory_resource::details::synchronized_memory_chunk_list mem_chunk_list;
