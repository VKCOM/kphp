...
TEST(string_test, test_to_int) {
  ...
  std::vector<TestCase> tests = {
    {" ", 0, 0},        {" ", 1, 0},         {" -123", 1, 0},    {" -123", 2, 0},    {" -123", 3, -1},    {" -123", 4, -12},
    {" -123", 5, -123}, {"  -123", 5, -12},  {"   -123", 5, -1}, {"    -123", 5, 0}, {"     -123", 5, 0}, {" +123", 1, 0},
    {" +123", 2, 0},    {" +123", 3, 1},     {" +123", 4, 12},   {" +123", 5, 123},  {"  +123", 5, 12},   {"   +123", 5, 1},
    {"    +123", 5, 0}, {"     +123", 5, 0}, {" 123 ", 1, 0},    {" 123 ", 2, 1},    {" 123 ", 3, 12},    {" 123 ", 4, 123},
    {" 123 ", 5, 123},  {"  123 ", 5, 123},  {"   123 ", 5, 12}, {"    123 ", 5, 1}, {"     123 ", 5, 0},
  };
