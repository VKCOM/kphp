...
TEST(confdata_key_maker_test, test_first_key_zero_dots) {
  std::unordered_map<std::string, ExpectedKey> samples{
    {"",             {ConfdataFirstKeyType::simple_key, "",             mixed{}}},
...
TEST(confdata_key_maker_test, test_first_key_one_dot_empty_second) {
  std::unordered_map<std::string, ExpectedKey> samples{
    {".",             {ConfdataFirstKeyType::one_dot_wildcard, ".",             mixed{string{}}}},
...
TEST(confdata_key_maker_test, test_first_key_one_dot_string_second) {
  std::unordered_map<std::string, ExpectedKey> samples{
    {".g",                {ConfdataFirstKeyType::one_dot_wildcard, ".",         mixed{string{"g"}}}},
    ...
    {"big.9223372036854775808",    {ConfdataFirstKeyType::one_dot_wildcard, "big.",      mixed{string{"9223372036854775808"}}}},
    {"small.-9223372036854775809", {ConfdataFirstKeyType::one_dot_wildcard, "small.",    mixed{string{"-9223372036854775809"}}}},
...
TEST(confdata_key_maker_test, test_first_key_one_dot_number_second) {
  std::unordered_map<std::string, ExpectedKey> samples{
    {".123",            {ConfdataFirstKeyType::one_dot_wildcard, ".",    mixed{123}}},
    ...
    {"max.9223372036854775807",  {ConfdataFirstKeyType::one_dot_wildcard, "max.", mixed{9223372036854775807L}}},
    {"min.-9223372036854775808", {ConfdataFirstKeyType::one_dot_wildcard, "min.", mixed{std::numeric_limits<int64_t>::min()}}}
  };
...
TEST(confdata_key_maker_test, test_first_key_two_dots_empty_second) {
  std::unordered_map<std::string, std::pair<ExpectedKey, ExpectedKey>> samples{
    {"..",             std::make_pair(
      ExpectedKey{ConfdataFirstKeyType::two_dots_wildcard, "..", mixed{string{}}},
      ExpectedKey{ConfdataFirstKeyType::one_dot_wildcard, ".", mixed{string{"."}}}
    )},
    {".ab.",           std::make_pair(
      ExpectedKey{ConfdataFirstKeyType::two_dots_wildcard, ".ab.", mixed{string{}}},
      ExpectedKey{ConfdataFirstKeyType::one_dot_wildcard, ".", mixed{string{"ab."}}}
    )},
    {"x..",            std::make_pair(
      ExpectedKey{ConfdataFirstKeyType::two_dots_wildcard, "x..", mixed{string{}}},
      ExpectedKey{ConfdataFirstKeyType::one_dot_wildcard, "x.", mixed{string{"."}}}
    )},
    {"x.y.",           std::make_pair(
      ExpectedKey{ConfdataFirstKeyType::two_dots_wildcard, "x.y.", mixed{string{}}},
      ExpectedKey{ConfdataFirstKeyType::one_dot_wildcard, "x.", mixed{string{"y."}}}
    )},
    {"1..",            std::make_pair(
      ExpectedKey{ConfdataFirstKeyType::two_dots_wildcard, "1..", mixed{string{}}},
      ExpectedKey{ConfdataFirstKeyType::one_dot_wildcard, "1.", mixed{string{"."}}}
    )},
    {"1.2.",           std::make_pair(
      ExpectedKey{ConfdataFirstKeyType::two_dots_wildcard, "1.2.", mixed{string{}}},
      ExpectedKey{ConfdataFirstKeyType::one_dot_wildcard, "1.", mixed{string{"2."}}}
    )},
    {"hello world!..", std::make_pair(
      ExpectedKey{ConfdataFirstKeyType::two_dots_wildcard, "hello world!..", mixed{string{}}},
...
TEST(confdata_key_maker_test, test_first_key_two_dots_string_second) {
  std::unordered_map<std::string, std::pair<ExpectedKey, ExpectedKey>> samples{
    {"..g",                   std::make_pair(
      ExpectedKey{ConfdataFirstKeyType::two_dots_wildcard, "..", mixed{string{"g"}}},
      ExpectedKey{ConfdataFirstKeyType::one_dot_wildcard, ".", mixed{string{".g"}}}
    )},
    {"x.g.g",                 std::make_pair(
      ExpectedKey{ConfdataFirstKeyType::two_dots_wildcard, "x.g.", mixed{string{"g"}}},
      ExpectedKey{ConfdataFirstKeyType::one_dot_wildcard, "x.", mixed{string{"g.g"}}}
    )},
    {"1.2.two",               std::make_pair(
      ExpectedKey{ConfdataFirstKeyType::two_dots_wildcard, "1.2.", mixed{string{"two"}}},
      ExpectedKey{ConfdataFirstKeyType::one_dot_wildcard, "1.", mixed{string{"2.two"}}}
    )},
    {"hello. .world!",        std::make_pair(
      ExpectedKey{ConfdataFirstKeyType::two_dots_wildcard, "hello. .", mixed{string{"world!"}}},
      ExpectedKey{ConfdataFirstKeyType::one_dot_wildcard, "hello.", mixed{string{" .world!"}}}
    )},
    {"big.num.9223372036854775808",    std::make_pair(
      ExpectedKey{ConfdataFirstKeyType::two_dots_wildcard, "big.num.", mixed{string{"9223372036854775808"}}},
    ...
    {"small.num.-9223372036854775809", std::make_pair(
      ExpectedKey{ConfdataFirstKeyType::two_dots_wildcard, "small.num.", mixed{string{"-9223372036854775809"}}},
      ExpectedKey{ConfdataFirstKeyType::one_dot_wildcard, "small.", mixed{string{"num.-9223372036854775809"}}}
    )},
    {"bad_num.0.-0",          std::make_pair(
      ExpectedKey{ConfdataFirstKeyType::two_dots_wildcard, "bad_num.0.", mixed{string{"-0"}}},
      ExpectedKey{ConfdataFirstKeyType::one_dot_wildcard, "bad_num.", mixed{string{"0.-0"}}}
    )},
    {"bad_num.1.1xx",         std::make_pair(
      ExpectedKey{ConfdataFirstKeyType::two_dots_wildcard, "bad_num.1.", mixed{string{"1xx"}}},
      ExpectedKey{ConfdataFirstKeyType::one_dot_wildcard, "bad_num.", mixed{string{"1.1xx"}}}
    )},
    {"bad_num.2.012",         std::make_pair(
      ExpectedKey{ConfdataFirstKeyType::two_dots_wildcard, "bad_num.2.", mixed{string{"012"}}},
