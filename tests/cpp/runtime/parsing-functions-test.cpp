...
TEST(parsing_functions_test, test_parse_ini_string_scanner_mode_typed) {
  ...
  // Sections false
  res = f$parse_ini_string(
    string("[types vars] int=1500 float=3.14242 str=\"hello world\" bool=true"),
    false,
    INI_SCANNER_TYPED);
  ...
  // Sections true
  res = f$parse_ini_string(
    string("[types vars] int=1500 float=3.14242 str=\"hello world\" bool1=true bool2=Off"),
    true,
    INI_SCANNER_TYPED);
