...
def _assert_rpc_parse(new_rpc_data: str, expected_result: bool):
    return _operation('rpc_parse', dict(new_rpc_data=new_rpc_data), expected_result)


def _assert_fetch_int(expected_result: int):
    return _operation('fetch_int', dict(), expected_result)


def _assert_fetch_long(expected_result: int):
    return _operation('fetch_long', dict(), expected_result)


def _assert_fetch_double(expected_result: float):
    return _operation('fetch_double', dict(), expected_result)


def _assert_fetch_string(expected_result: str):
