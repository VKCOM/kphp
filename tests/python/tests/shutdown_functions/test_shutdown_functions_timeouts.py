...
class TestShutdownFunctionsTimeouts(WebServerAutoTestCase):
    @classmethod
    ...
    def test_timeout_after_timeout_at_shutdown_function(self):
        ...
        self.assertEqual(resp.text, "ERROR")
        self.assertEqual(resp.status_code, 500)
        self.web_server.assert_log(["Critical error during script execution: hard timeout exit"], timeout=5)
    ...
    #             {"op": "fork_send_rpc_without_wait", "duration": 0.5, "master_port": self.web_server.master_port},
    #             {"op": "long_work", "duration": 2}
    #         ])
    #     self.assertEqual(resp.text, "ERROR")
    #     self.assertEqual(resp.status_code, 500)
    #     self.web_server.assert_log(["RPC request sent successfully = 1",
    ...
    #         json=[
    #             {"op": "register_shutdown_function", "msg": "shutdown_after_long_work"},
    #             {"op": "send_long_rpc", "duration": 1, "master_port": self.web_server.master_port},
    #         ])
    #     self.assertEqual(resp.text, "ERROR")
    #     self.assertEqual(resp.status_code, 500)
    #     self.web_server.assert_log(["Critical error during script execution: timeout",
