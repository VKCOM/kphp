...
class TestKML(KphpCompilerAutoTestCase):
    ...
    def test_catboost_catboost_tiny_vectors_float_and_categorial(self):
        self.compile_and_check_success(php_script_path="catboost/php/catboost_tiny_vectors_float_and_categorial.php",
                                       kml_dir="catboost/kml")

    def test_catboost_catboost_tiny_vectors_float_and_categorial_multi(self):
        self.compile_and_check_success(php_script_path="catboost/php/catboost_tiny_vectors_float_and_categorial_multi.php",
                                       kml_dir="catboost/kml")
