...
class TestJobSharedMessages(KphpServerAutoTestCase):
    ...
    def test_job_workers_shared_messages_option(self):
        self._do_test(
            ...
            reserved={"messages": 50, "1mb": 7, "2mb": 0, "4mb": 0, "8mb": 0, "16mb": 0, "32mb": 0, "64mb": 0}
        )
        self._do_test(
            kphp_options={
                "--workers-num": 10, "--job-workers-ratio": 0.2,
            ...
            reserved={"messages": 100, "1mb": 30, "2mb": 0, "4mb": 0, "8mb": 0, "16mb": 0, "32mb": 0, "64mb": 0}
        )
        self._do_test(
            kphp_options={
                "--workers-num": 4, "--job-workers-ratio": 0.5,
        ...
        self._do_test(
            kphp_options={
                "--workers-num": 10, "--job-workers-ratio": 0.2,
                "--job-workers-shared-messages": 10, "--job-workers-shared-memory-size": None
            },
            reserved={"messages": 10, "1mb": 5, "2mb": 3, "4mb": 2, "8mb": 1, "16mb": 1, "32mb": 1, "64mb": 0}
        )
    ...
    def test_job_workers_shared_messages_and_memory_size_option(self):
        self._do_test(
            ...
            reserved={"messages": 50, "1mb": 26, "2mb": 12, "4mb": 7, "8mb": 2, "16mb": 0, "32mb": 0, "64mb": 0}
        )
        self._do_test(
            kphp_options={
                "--workers-num": 10, "--job-workers-ratio": 0.2,
            ...
            reserved={"messages": 100, "1mb": 51, "2mb": 25, "4mb": 13, "8mb": 7, "16mb": 3, "32mb": 2, "64mb": 2}
        )
        self._do_test(
            kphp_options={
                "--workers-num": 4, "--job-workers-ratio": 0.5,
        ...
        self._do_test(
            kphp_options={
                "--workers-num": 10, "--job-workers-ratio": 0.2,
                "--job-workers-shared-messages": 10, "--job-workers-shared-memory-size": "500M"
            },
            reserved={"messages": 10, "1mb": 6, "2mb": 2, "4mb": 1, "8mb": 2, "16mb": 1, "32mb": 2, "64mb": 6}
        )
